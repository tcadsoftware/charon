...
class charonHarmonicBalancePhaseShiftsModifier0:
    "class for modifying the charonHarmonicBalancePhaseShiftsModifier0 parameterList"


    def __init__(self):
        self.modifierName = "charonHarmonicBalancePhaseShiftsModifier0"
