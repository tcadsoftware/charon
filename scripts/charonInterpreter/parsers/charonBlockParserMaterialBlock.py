...
class charonBlockParserMaterialBlock:
    "MaterialBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start material block"
        self.parserBlockName = "MaterialBlock"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgument.append("{MaterialBlockName}")
        self.blockArgumentIndexes = []
        self.blockArgumentIndexes.append(3)
        self.interpreterBlockHelpLine = "start Material Block {MaterialBlockName} "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models,Concentration Scaling,double,1e16")
