...
class charonBlockParserSurfaceTrap:
    "SurfaceTrap parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start surface trap"
        self.parserBlockName = "SurfaceTrap"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Surface Trap "
