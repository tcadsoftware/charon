...
class charonBlockParserTrapParams:
    "TrapParams parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start trap"
        self.parserBlockName = "TrapParams"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgument.append("{trapID}")
        self.blockArgumentIndexes = []
        self.blockArgumentIndexes.append(2)
        self.interpreterBlockHelpLine = "start Trap {trapID} "
