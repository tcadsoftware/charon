...
import sys
from .charonLineParserTrapEnergy import *
...
class TrapParamsParserLib:
    "This is the  TrapParamsParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "TrapParamsParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserTrapEnergy())
