...
class charonLineParserTrapDensity:
    "TrapDensity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TrapDensity"
        self.parsingKey = "density ="
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "density = {trapDensity} "
        self.interpreterQuickHelp = "Specify surface trap density in cm^-2"
        self.interpreterLongHelp = "Specify surface trap density in cm^-2"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap->Trap {trapID},Trap Density,double,{trapDensity}")
        ...
        self.xmlRequiredArgument.append("{trapDensity}")
