...
class charonLineParserTrapType:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "type is {trapType} "
        self.interpreterQuickHelp = "Specify surface trap type which is either Acceptor or Donor"
        self.interpreterLongHelp = "Specify surface trap type which is either Acceptor or Donor"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap->Trap {trapID},Trap Type,string,{trapType}")
        ...
        self.xmlRequiredArgument.append("{trapType}")
