...
class charonLineParserCrossSection:
    "CrossSection parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CrossSection"
        self.parsingKey = "cross section for"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("holes =")
        self.parsingKeyOptional.append("electrons =")
        self.interpreterHelpLine = "cross section for [holes = {hXsec} [electrons = {eXsec}] ] "
        self.interpreterQuickHelp = "Specify the cross section for electrons and holes in unit of cm^2"
        self.interpreterLongHelp = "Specify the cross section for electrons and holes in unit of cm^2"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap->Trap {trapID},Hole Cross Section,double,{hXsec}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap->Trap {trapID},Electron Cross Section,double,{eXsec}")
        ...
        self.xmlOptionalArgument = [['{hXsec}'], ['{eXsec}']]
