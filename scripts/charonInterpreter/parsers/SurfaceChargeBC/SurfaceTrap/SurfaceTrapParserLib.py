...
import sys
from .charonLineParserEffectiveMass import *
from .charonBlockParserTrapParams import *
from .TrapParams.TrapParamsParserLib import *



class SurfaceTrapParserLib:
    "This is the  SurfaceTrapParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "SurfaceTrapParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserEffectiveMass())
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserTrapParams(),TrapParamsParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(TrapParamsParserLib())
