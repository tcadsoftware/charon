...
class charonLineParserEffectiveMass:
    "EffectiveMass parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EffectiveMass"
        self.parsingKey = "effective mass for"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("holes =")
        self.parsingKeyOptional.append("electrons =")
        self.interpreterHelpLine = "effective mass for [holes = {hMass} [electrons = {eMass}] ] "
        self.interpreterQuickHelp = "Specify the effective mass for electrons and holes in unit of m0"
        self.interpreterLongHelp = "Specify the effective mass for electrons and holes in unit of m0"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap,Hole Effective Mass,double,{hMass}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Trap,Electron Effective Mass,double,{eMass}")
        ...
        self.xmlOptionalArgument = [['{hMass}'], ['{eMass}']]
