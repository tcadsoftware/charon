...
class charonLineParserGeometryBlock:
    "GeometryBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "GeometryBlock"
        self.parsingKey = "geometry block is"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "geometry block is {geometryBlock} "
        self.interpreterQuickHelp = "Specify the geometry block name"
        self.interpreterLongHelp = "Specify the geometry block that the SurfaceChargeBC is applied to"
