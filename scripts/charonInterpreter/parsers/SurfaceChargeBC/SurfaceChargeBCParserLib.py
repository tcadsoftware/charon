...
import sys
from .charonLineParserFixedCharge import *
from .charonLineParserGeometryBlock import *
from .charonBlockParserSurfaceTrap import *
from .charonBlockParserSurfaceRecomb import *
from .SurfaceTrap.SurfaceTrapParserLib import *
from .SurfaceRecomb.SurfaceRecombParserLib import *



class SurfaceChargeBCParserLib:
    "This is the  SurfaceChargeBCParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "SurfaceChargeBCParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserFixedCharge())
        self.lineParsers.append(charonLineParserGeometryBlock())
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserSurfaceTrap(),SurfaceTrapParserLib()])
        self.blockParsers.append([charonBlockParserSurfaceRecomb(),SurfaceRecombParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(SurfaceTrapParserLib())
        parserLibraries.append(SurfaceRecombParserLib())
