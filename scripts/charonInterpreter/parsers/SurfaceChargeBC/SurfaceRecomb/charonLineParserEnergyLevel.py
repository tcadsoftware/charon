...
class charonLineParserEnergyLevel:
    "EnergyLevel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EnergyLevel"
        self.parsingKey = "energy ="
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "energy = {energy} "
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Recombination,Energy Level,double,{energy}")
        ...
        self.xmlRequiredArgument.append("{energy}")
