...
class charonLineParserSurfaceVelocity:
    "SurfaceVelocity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SurfaceVelocity"
        self.parsingKey = "surface velocity for"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("holes =")
        self.parsingKeyOptional.append("electrons =")
        self.interpreterHelpLine = "surface velocity for [holes = {hSurfVel} [electrons = {eSurfVel}] ] "
        self.interpreterQuickHelp = "Specify surface recombination velocity for electrons and holes in unit of cm/s"
        self.interpreterLongHelp = "Specify surface recombination velocity for electrons and holes in unit of cm/s"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Recombination,Hole Surface Velocity,double,{hSurfVel}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data->Surface Recombination,Electron Surface Velocity,double,{eSurfVel}")
        ...
        self.xmlOptionalArgument = [['{hSurfVel}'], ['{eSurfVel}']]
        self.xmlOptionalArgumentIndexes = [[2], [2]]
