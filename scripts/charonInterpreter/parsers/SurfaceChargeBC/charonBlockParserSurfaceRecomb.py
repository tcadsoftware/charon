...
class charonBlockParserSurfaceRecomb:
    "SurfaceRecomb parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start surface recombination"
        self.parserBlockName = "SurfaceRecomb"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start surface recombination "
