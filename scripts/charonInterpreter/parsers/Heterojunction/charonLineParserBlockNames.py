...
class charonLineParserBlockNames:
    "BlockNames parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BlockNames"
        self.parsingKey = "junction is between blocks"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "junction is between blocks {block1var} and {block2var} "
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS,Element Block ID,string,{block1var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS,Element Block ID2,string,{block2var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS,Element Block ID,string,{block2var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS,Element Block ID2,string,{block1var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS,Element Block ID,string,{block1var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS,Element Block ID2,string,{block2var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS,Element Block ID,string,{block2var}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS,Element Block ID2,string,{block1var}")
        ...
        self.xmlRequiredArgument.append("{block1var}")
        self.xmlRequiredArgument.append("{block2var}")
