...
class charonLineParserFermiDirac:
    ...
    def __init__(self):
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS->Data,Fermi Dirac Density,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS->Data,Fermi Dirac Density,double,{value}")
