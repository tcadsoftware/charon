...
class charonLineParserTunnelingEffMass:
    ...
    def __init__(self):
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS->Data,Tunneling Effective Mass,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS->Data,Tunneling Effective Mass,double,{value}")
