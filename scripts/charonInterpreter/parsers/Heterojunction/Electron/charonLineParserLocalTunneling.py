...
class charonLineParserLocalTunneling:
    "LocalTunneling parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LocalTunneling"
        self.parsingKey = "local tunneling"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("on")
        self.parsingKeyOptional.append("off")
        self.interpreterHelpLine = "local tunneling is [ on [ off ]] "
        self.interpreterQuickHelp = "Set local tunneling on or off"
        self.interpreterLongHelp = "Set local tunneling on or off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->elec1ANONYMOUS->Data,Local Tunneling,string,True")
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->elec2ANONYMOUS->Data,Local Tunneling,string,True")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->elec1ANONYMOUS->Data,Local Tunneling,string,False")
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->elec2ANONYMOUS->Data,Local Tunneling,string,False")
