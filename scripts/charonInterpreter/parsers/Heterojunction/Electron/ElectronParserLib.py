...
import sys
from .charonLineParserTunnelingEffMass import *
from .charonLineParserDiscretizationMethod import *
from .charonLineParserEffMass import *
from .charonLineParserFermiDirac import *
from .charonLineParserLocalTunneling import *
from .charonLineParserBandOff import *



class ElectronParserLib:
    "This is the  ElectronParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "ElectronParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserTunnelingEffMass())
        self.lineParsers.append(charonLineParserDiscretizationMethod())
        self.lineParsers.append(charonLineParserEffMass())
        self.lineParsers.append(charonLineParserFermiDirac())
        self.lineParsers.append(charonLineParserLocalTunneling())
        self.lineParsers.append(charonLineParserBandOff())
