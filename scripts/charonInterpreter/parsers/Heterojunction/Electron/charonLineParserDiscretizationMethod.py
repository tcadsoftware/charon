...
class charonLineParserDiscretizationMethod:
    "DiscretizationMethod parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DiscretizationMethod"
        self.parsingKey = "discretization method"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("fem")
        self.parsingKeyOptional.append("cvfem")
        self.interpreterHelpLine = "discretization method is [ fem [ cvfem ]] "
        self.interpreterQuickHelp = "Which method to use for current density calculations"
        self.interpreterLongHelp = "Which method to use for current density calculations"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->elec1ANONYMOUS->Data,Discretization Method,string,FEM-SUPG")
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->elec2ANONYMOUS->Data,Discretization Method,string,FEM-SUPG")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->elec1ANONYMOUS->Data,Discretization Method,string,CVFEM-SG")
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->elec2ANONYMOUS->Data,Discretization Method,string,CVFEM-SG")
