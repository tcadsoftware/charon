...
class charonLineParserBandOff:
    "BandOff parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BandOff"
        self.parsingKey = "band offset"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "band offset = {value} "
        self.interpreterQuickHelp = "Set the band offset"
        self.interpreterLongHelp = "Set the band offset"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS->Data,Band Offset,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS->Data,Band Offset,double,{value}")
