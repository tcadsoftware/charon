...
class charonLineParserEffMass:
    "EffMass parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EffMass"
        self.parsingKey = "effective mass"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "effective mass = {value} "
        self.interpreterQuickHelp = "Set the effective mass"
        self.interpreterLongHelp = "Set the effective mass"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec1ANONYMOUS->Data,Effective Mass,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->elec2ANONYMOUS->Data,Effective Mass,double,{value}")
