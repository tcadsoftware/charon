...
import sys
from .charonLineParserBlockNames import *
from .charonBlockParserHole import *
from .charonBlockParserElectron import *
from .Hole.HoleParserLib import *
from .Electron.ElectronParserLib import *



class HeterojunctionParserLib:
    "This is the  HeterojunctionParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "HeterojunctionParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserBlockNames())
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserHole(),HoleParserLib()])
        self.blockParsers.append([charonBlockParserElectron(),ElectronParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(HoleParserLib())
        parserLibraries.append(ElectronParserLib())
