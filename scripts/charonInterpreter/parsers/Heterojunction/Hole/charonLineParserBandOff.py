...
class charonLineParserBandOff:
    ...
    def __init__(self):
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS->Data,Band Offset,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS->Data,Band Offset,double,{value}")
