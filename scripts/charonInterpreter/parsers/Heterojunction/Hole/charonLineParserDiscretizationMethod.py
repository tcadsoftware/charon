...
class charonLineParserDiscretizationMethod:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->hole1ANONYMOUS->Data,Discretization Method,string,FEM-SUPG")
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->hole2ANONYMOUS->Data,Discretization Method,string,FEM-SUPG")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->hole1ANONYMOUS->Data,Discretization Method,string,CVFEM-SG")
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->hole2ANONYMOUS->Data,Discretization Method,string,CVFEM-SG")
