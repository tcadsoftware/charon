...
class charonLineParserTunnelingEffMass:
    "TunnelingEffMass parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TunnelingEffMass"
        self.parsingKey = "tunneling effective mass"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "tunneling effective mass = {value} "
        self.interpreterQuickHelp = "Set the carrier effective mass for the local tunneling calculation"
        self.interpreterLongHelp = "Set the carrier effective mass for the local tunneling calculation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS->Data,Tunneling Effective Mass,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS->Data,Tunneling Effective Mass,double,{value}")
