...
class charonLineParserLocalTunneling:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->hole1ANONYMOUS->Data,Local Tunneling,string,True")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->hole1ANONYMOUS->Data,Local Tunneling,string,True")
