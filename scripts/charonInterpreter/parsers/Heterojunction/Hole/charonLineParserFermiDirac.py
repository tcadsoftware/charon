...
class charonLineParserFermiDirac:
    ...
    def __init__(self):
        ...
        self.parsingKey = "fermi dirac density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "fermi dirac density = {value} "
        self.interpreterQuickHelp = "Set the fermi dirac density"
        self.interpreterLongHelp = "Set the fermi dirac density"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS->Data,Fermi Dirac Density,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS->Data,Fermi Dirac Density,double,{value}")
