...
class charonLineParserEffMass:
    ...
    def __init__(self):
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole1ANONYMOUS->Data,Effective Mass,double,{value}")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->hole2ANONYMOUS->Data,Effective Mass,double,{value}")
