...
class charonLineParserWorkFunction:
    "WorkFunction parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "WorkFunction"
        self.parsingKey = "work function"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "work function = {wf} "
        self.interpreterQuickHelp = "Sets work function for Schottky contact"
        self.interpreterLongHelp = "Sets work function for Schottky contact <> wf is the value of the work function"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS->Data,Work Function,double,{wf}")
        ...
        self.xmlRequiredArgument.append("{wf}")
