...
class charonLineParserGamma:
    ...
    def __init__(self):
        ...
        self.parsingKey = "gamma"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "gamma = {gamma} "
        self.interpreterQuickHelp = "Set the barrier lowering model gamma value."
        self.interpreterLongHelp = "Set the barrier lowering model gamma value."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Barrier Lowering,gamma,double,{gamma}")
