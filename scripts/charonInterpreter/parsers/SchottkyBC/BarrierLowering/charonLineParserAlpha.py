...
class charonLineParserAlpha:
    "Alpha parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Alpha"
        self.parsingKey = "alpha"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "alpha = {alpha} "
        self.interpreterQuickHelp = "Set the barrier lowering model alpha value."
        self.interpreterLongHelp = "Set the barrier lowering model alpha value."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Barrier Lowering,alpha,double,{alpha}")
        ...
        self.xmlRequiredArgument.append("{alpha}")
