...
import sys
from .charonLineParserMass import *



class BarrierTunnelingParserLib:
    "This is the  BarrierTunnelingParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "BarrierTunnelingParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserMass())
