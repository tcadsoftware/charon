...
class charonBlockParserBarrierTunneling:
    "BarrierTunneling parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start barrier tunneling parameters"
        self.parserBlockName = "BarrierTunneling"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Barrier Tunneling Parameters "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Tunneling,mass,double,1.0")
