...
class charonLineParserVoltage:
    "Voltage parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Voltage"
        self.parsingKey = "voltage is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("fixed at")
        self.parsingKeyOptional.append("swept from")
        self.interpreterHelpLine = "voltage is [fixed at {potential}[ swept from {potential1} to {potential2}]] "
        self.interpreterQuickHelp = "Sets voltage for Schottky contact"
        self.interpreterLongHelp = "Sets voltage for Schottky contact"
