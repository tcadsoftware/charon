...
class charonBlockParserBarrierLowering:
    "BarrierLowering parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start barrier lowering parameters"
        self.parserBlockName = "BarrierLowering"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Barrier Lowering Parameters "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Barrier Lowering,alpha,double,1.0")
        self.xmlDefaultLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Barrier Lowering,beta,double,0.0")
        self.xmlDefaultLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data->Barrier Lowering,gamma,double,1.0")
