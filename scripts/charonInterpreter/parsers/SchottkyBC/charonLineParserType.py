...
class charonLineParserType:
    "Type parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Type"
        self.parsingKey = "type"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is electron")
        self.parsingKeyOptional.append("is hole")
        self.interpreterHelpLine = "type [ is electron [ is hole] ] "
        self.interpreterQuickHelp = "Sets type for Schottky contact"
        self.interpreterLongHelp = "Sets type for Schottky contact <> electron or hole"
        ...
        self.xmlOptionalLines[0].append(" Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data,Type,string,Electron")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data,Type,string,Hole")
