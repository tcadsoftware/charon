...
import sys
from .charonLineParserVoltage import *
from .charonLineParserWorkFunction import *
from .charonLineParserHoleRichardsonConst import *
from .charonLineParserType import *
from .charonLineParserElectronRichardsonConst import *
from .charonBlockParserBarrierLowering import *
from .charonBlockParserBarrierTunneling import *
from .BarrierLowering.BarrierLoweringParserLib import *
from .BarrierTunneling.BarrierTunnelingParserLib import *



class SchottkyBCParserLib:
    "This is the  SchottkyBCParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "SchottkyBCParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserVoltage())
        self.lineParsers.append(charonLineParserWorkFunction())
        self.lineParsers.append(charonLineParserHoleRichardsonConst())
        self.lineParsers.append(charonLineParserType())
        self.lineParsers.append(charonLineParserElectronRichardsonConst())
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserBarrierLowering(),BarrierLoweringParserLib()])
        self.blockParsers.append([charonBlockParserBarrierTunneling(),BarrierTunnelingParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(BarrierLoweringParserLib())
        parserLibraries.append(BarrierTunnelingParserLib())
