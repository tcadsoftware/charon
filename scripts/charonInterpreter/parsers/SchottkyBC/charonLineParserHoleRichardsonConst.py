...
class charonLineParserHoleRichardsonConst:
    "HoleRichardsonConst parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HoleRichardsonConst"
        self.parsingKey = "hole richardson constant"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Hole Richardson Constant = {Ap} "
        self.interpreterQuickHelp = "Sets hole Richardson constant for Schottky contact"
        self.interpreterLongHelp = "Sets hole Richardson constant for Schottky contact"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->SchottkyNeumann{sidesetID}ANONYMOUS->Data,Hole Richardson Constant,double,{Ap}")
        ...
        self.xmlRequiredArgument.append("{Ap}")
