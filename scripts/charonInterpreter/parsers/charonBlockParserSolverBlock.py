...
class charonBlockParserSolverBlock:
    "SolverBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start solver block"
        self.parserBlockName = "SolverBlock"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start solver block "
