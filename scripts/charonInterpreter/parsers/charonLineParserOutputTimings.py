...
class charonLineParserOutputTimings:
    "OutputTimings parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OutputTimings"
        self.parsingKey = "output timing information"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "output timing information [ is on [ is off ]] "
        self.interpreterQuickHelp = "Enable/disable output of detailed timing information."
        self.interpreterLongHelp = "Enable/disable output of detailed execution timings for parts of the code that support it."
        ...
        self.xmlOptionalLines[0].append("  Charon->Options,Output Timings,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append("  Charon->Options,Output Timings,bool,false")
