...
class charonBlockParserPhysicsBlock:
    "PhysicsBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start physics block"
        self.parserBlockName = "PhysicsBlock"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgument.append("{physicsBlockName}")
        self.blockArgumentIndexes = []
        self.blockArgumentIndexes.append(3)
        self.interpreterBlockHelpLine = "start physics block {physicsBlockName} "
