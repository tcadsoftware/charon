...
class charonLineParserIfpackLevelOfFill:
    "IfpackLevelOfFill parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "IfpackLevelOfFill"
        self.parsingKey = "ifpack level of fill"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "ifpack level of fill = {level} "
        self.interpreterQuickHelp = "Specify Ifpack level of fill"
        self.interpreterLongHelp = "Specify Ifpack level of fill"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack->Ifpack Settings,fact: level-of-fill,int,{level}")
        ...
        self.xmlRequiredArgument.append("{level}")
