...
class charonLineParserAztecKrylovSubSize:
    "AztecKrylovSubSize parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AztecKrylovSubSize"
        self.parsingKey = "aztec krylov subspace size"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "aztec krylov subspace size = {size} "
        self.interpreterQuickHelp = "Specify Aztec Krylov Subspace Size"
        self.interpreterLongHelp = "Specify Aztec Krylov Subspace Size "

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->AztecOO->Forward Solve->AztecOO Settings,Size of Krylov Subspace,int,{size}")
        ...
        self.xmlRequiredArgument.append("{size}")
