...
class charonLineParserNoxSolver:
    "NoxSolver parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NoxSolver"
        self.parsingKey = "use nox solver"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use NOX solver "
        self.interpreterQuickHelp = "Specify the use of the steady-state nox solver"
        self.interpreterLongHelp = "Specify the use of the steady-state nox solver"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control,Piro Solver,string,NOX")
        self.xmlRequiredLines.append("Charon->Solution Control,Compute Sensitivities,bool,0")
        self.xmlRequiredLines.append("Charon->Solution Control,Jacobian Operator,string,Have Jacobian")
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction,Method,string,Newton")
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Newton,Forcing Term Method,string,Constant")
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Newton,Rescue Bad Newton Solve,bool,1")
