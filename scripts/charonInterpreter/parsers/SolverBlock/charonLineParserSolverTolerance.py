...
class charonLineParserSolverTolerance:
    "SolverTolerance parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverTolerance"
        self.parsingKey = "nonlinear solver tolerance"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "nonlinear solver tolerance = {tolerance} "
        self.interpreterQuickHelp = "Specify the non linear solver tolerance"
        self.interpreterLongHelp = "Specify the non linear solver tolerance <> tolerance = tolerance value for norm of residual"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Status Tests->Test 0,Tolerance,double,{tolerance}")
        ...
        self.xmlRequiredArgument.append("{tolerance}")
