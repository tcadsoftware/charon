...
class charonLineParserTimeIntegratorMaxTimeStepSize:
    "TimeIntegratorMaxTimeStepSize parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TimeIntegratorMaxTimeStepSize"
        self.parsingKey = "time integrator maximum step size"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "time integrator maximum step size = {dtime} "
        self.interpreterQuickHelp = "Specify the maximum time step size the intergrator is allowed to take."
        self.interpreterLongHelp = "Specify the maximum time step size the intergrator is allowed to take. <> dtime is the time step in seconds."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->Rythmos->Rythmos Integration Control,Max dt,double,{dtime}")
        self.xmlRequiredLines.append("Charon->Solution Control->Rythmos->Rythmos Step Control Strategy,Max Step Size,double,{dtime}")
        ...
        self.xmlRequiredArgument.append("{dtime}")
