...
class charonLineParserLineSearchMethod:
    "LineSearchMethod parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LineSearchMethod"
        self.parsingKey = "line search method"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("full step")
        self.parsingKeyOptional.append("backtrack")
        self.interpreterHelpLine = "line search method is [ full step [ backtrack ]] "
        self.interpreterQuickHelp = "Specify the line search method  Full Step or Backtrack"
        self.interpreterLongHelp = "Specify the line search method  Full Step or Backtrack"
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->NOX->Line Search,Method,string,Full Step")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solution Control->NOX->Line Search,Method,string,Backtrack")
