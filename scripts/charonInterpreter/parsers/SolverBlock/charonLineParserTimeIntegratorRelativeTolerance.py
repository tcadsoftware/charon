...
class charonLineParserTimeIntegratorRelativeTolerance:
    "TimeIntegratorRelativeTolerance parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TimeIntegratorRelativeTolerance"
        self.parsingKey = "time integrator relative error"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "time integrator relative error = {error} "
        self.interpreterQuickHelp = "Specify the time integrator relative error tolerance"
        self.interpreterLongHelp = "Specify time integrator relative error tolerance <> {error = target value for the relative error requirement"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->Rythmos->Rythmos Step Control Strategy,Relative Error Tolerance,double,{error}")
        ...
        self.xmlRequiredArgument.append("{error}")
