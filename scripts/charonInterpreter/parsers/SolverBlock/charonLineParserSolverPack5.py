...
class charonLineParserSolverPack5:
    "SolverPack5 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverPack5"
        self.parsingKey = "use solver pack 5"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use solver pack 5 "
        self.interpreterQuickHelp = "Specify the use of the steady-state solver pack 5"
        self.interpreterLongHelp = "Specify the use of the steady-state solver pack 5"
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->AztecOO->Forward Solve,Max Iterations,int,500")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->AztecOO->Forward Solve,Tolerance,double,1.0e-5")
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 0,Tolerance,double,1.0e-5")
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,Relative Tolerance,double,1.0e-10")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,Absolute Tolerance,double,1.0e-16")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,alpha,double,1.0")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,beta,double,0.5")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 1,Test Type,string,MaxIters")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 1,Maximum Iterations,int,20")
