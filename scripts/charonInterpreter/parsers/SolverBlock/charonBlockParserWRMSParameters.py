...
class charonBlockParserWRMSParameters:
    "WRMSParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start wrms parameters block"
        self.parserBlockName = "WRMSParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start wrms parameters block "
