...
class charonLineParserSolverPack4:
    "SolverPack4 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverPack4"
        self.parsingKey = "use solver pack 4"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use solver pack 4 "
        self.interpreterQuickHelp = "Specify the use of the steady-state solver pack 4"
        self.interpreterLongHelp = "Specify the use of the steady-state solver pack 4"
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko,Inverse Type,string,GS")
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->GS,Type,string,Block Gauss-Seidel")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->GS,Use Upper Triangle,bool,true")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->GS,Inverse Type 1,string,ILU")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->GS,Inverse Type 2,string,Id")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU,Type,string,Ifpack")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU,Overlap,int,1")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU,Prec Type,string,ILU")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU->Ifpack Settings,fact: drop tolerance,double,0")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU->Ifpack Settings,fact: ilut level-of-fill,double,1")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->ILU->Ifpack Settings,fact: level-of-fill,int,1")
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Teko->Inverse Factory Library->Id,Type,string,Identity")
