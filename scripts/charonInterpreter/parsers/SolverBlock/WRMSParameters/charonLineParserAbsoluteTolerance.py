...
class charonLineParserAbsoluteTolerance:
    "AbsoluteTolerance parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AbsoluteTolerance"
        self.parsingKey = "absolute tolerance"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "absolute tolerance = {absTol} "
        self.interpreterQuickHelp = "Set the WRMS absolute tolerance for the nonlinear solver status test."
        self.interpreterLongHelp = "Set the WRMS absolute tolerance for the nonlinear solver status test."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,Absolute Tolerance,double,{absTol}")
        ...
        self.xmlRequiredArgument.append("{absTol}")
