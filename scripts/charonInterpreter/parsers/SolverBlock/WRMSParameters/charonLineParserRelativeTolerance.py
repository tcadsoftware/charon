...
class charonLineParserRelativeTolerance:
    "RelativeTolerance parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "RelativeTolerance"
        self.parsingKey = "relative tolerance"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "relative tolerance = {relTol} "
        self.interpreterQuickHelp = "Set the WRMS relative tolerance for the nonlinear solver status test."
        self.interpreterLongHelp = "Set the WRMS relative tolerance for the nonlinear solver status test."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,Relative Tolerance,double,{relTol}")
        ...
        self.xmlRequiredArgument.append("{relTol}")
