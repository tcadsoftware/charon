...
class charonLineParserAlphaParameter:
    "AlphaParameter parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AlphaParameter"
        self.parsingKey = "alpha"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "alpha = {alphaVal} "
        self.interpreterQuickHelp = "Set the WRMS alpha parameter for the nonlinear solver status test."
        self.interpreterLongHelp = "Set the WRMS alpha parameter for the nonlinear solver status test."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,alpha,double,{alphaVal}")
        ...
        self.xmlRequiredArgument.append("{alphaVal}")
