...
import sys
from .charonLineParserRelativeTolerance import *
from .charonLineParserBetaParameter import *
from .charonLineParserAlphaParameter import *
from .charonLineParserAbsoluteTolerance import *



class WRMSParametersParserLib:
    "This is the  WRMSParametersParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "WRMSParametersParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserRelativeTolerance())
        self.lineParsers.append(charonLineParserBetaParameter())
        self.lineParsers.append(charonLineParserAlphaParameter())
        self.lineParsers.append(charonLineParserAbsoluteTolerance())
