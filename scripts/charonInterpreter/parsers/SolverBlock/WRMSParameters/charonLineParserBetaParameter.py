...
class charonLineParserBetaParameter:
    "BetaParameter parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BetaParameter"
        self.parsingKey = "beta"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "beta = {betaVal} "
        self.interpreterQuickHelp = "Set the WRMS beta parameter for the nonlinear solver status test."
        self.interpreterLongHelp = "Set the WRMS beta parameter for the nonlinear solver status test."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,beta,double,{betaVal}")
        ...
        self.xmlRequiredArgument.append("{betaVal}")
