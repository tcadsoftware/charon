...
class charonLineParserSolverPack1:
    "SolverPack1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverPack1"
        self.parsingKey = "use solver pack 1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use solver pack 1 "
        self.interpreterQuickHelp = "Specify the use of the steady-state solver pack 1"
        self.interpreterLongHelp = "Specify the use of the steady-state solver pack 1"
