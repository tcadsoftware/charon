...
class charonLineParserLinearSolverType:
    "LinearSolverType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LinearSolverType"
        self.parsingKey = "linear solver"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "linear solver is {linearSolver} "
        self.interpreterQuickHelp = "Specify the linear solver type"
        self.interpreterLongHelp = "Specify the linear solver type  AztecOO  Belos  or others"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos,Linear Solver Type,string,{linearSolver}")
        ...
        self.xmlRequiredArgument.append("{linearSolver}")
