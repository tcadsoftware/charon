...
class charonLineParserAztecTolerance:
    "AztecTolerance parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AztecTolerance"
        self.parsingKey = "aztec tolerance"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "aztec tolerance = {tolerance} "
        self.interpreterQuickHelp = "Specify Aztec tolerance"
        self.interpreterLongHelp = "Specify Aztec tolerance"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->AztecOO->Forward Solve,Tolerance,double,{tolerance}")
