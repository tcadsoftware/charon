...
class charonLineParserGMRESILU:
    "GMRESILU parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "GMRESILU"
        self.parsingKey = "use solver gmres-ilu"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use solver GMRES-ILU "
        self.interpreterQuickHelp = "Specify the use of the steady-state solver GMRES-ILU"
        self.interpreterLongHelp = "Specify the use of the steady-state solver GMRES-ILU  <>  This line sets the solver to a GMRES linear solver with ILU preconditioning."
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->NOX->Status Tests->Test 0->Test 1,alpha,double,0.5")
