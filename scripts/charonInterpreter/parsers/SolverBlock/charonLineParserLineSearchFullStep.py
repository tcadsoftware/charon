...
class charonLineParserLineSearchFullStep:
    "LineSearchFullStep parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LineSearchFullStep"
        self.parsingKey = "line search full step"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "line search full step [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on Line Search full step"
        self.interpreterLongHelp = "Turn on Line Search full step <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->NOX->Line Search->Full Step,Full Step,double,1")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solution Control->NOX->Line Search->Full Step,Full Step,double,0")
