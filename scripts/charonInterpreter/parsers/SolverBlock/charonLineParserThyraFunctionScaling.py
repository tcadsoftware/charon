...
class charonLineParserThyraFunctionScaling:
    "ThyraFunctionScaling parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ThyraFunctionScaling"
        self.parsingKey = "thyra function scaling"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("row sum")
        self.parsingKeyOptional.append("none")
        self.parsingKeyOptional.append("user defined")
        self.interpreterHelpLine = "thyra function scaling is [ Row Sum [ None [ User Defined ]]]] "
        self.interpreterQuickHelp = "Specify Thyra function scaling type"
        self.interpreterLongHelp = "Specify Thyra function scaling type "
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->NOX->Thyra Group Options,Function Scaling,string,Row Sum")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solution Control->NOX->Thyra Group Options,Function Scaling,string,None")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Solution Control->NOX->Thyra Group Options,Function Scaling,string,User Defined")
