...
class charonLineParserIfpackReorderingType:
    "IfpackReorderingType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "IfpackReorderingType"
        self.parsingKey = "ifpack reordering type"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "ifpack reordering type is {type} "
        self.interpreterQuickHelp = "Specify Ifpack reordering type"
        self.interpreterLongHelp = "Specify Ifpack reordering type"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack->Ifpack Settings,schwarz: reordering type,string,{type}")
        ...
        self.xmlRequiredArgument.append("{type}")
