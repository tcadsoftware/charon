...
class charonLineParserSolverPack7:
    "SolverPack7 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverPack7"
        self.parsingKey = "use solver pack 7"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use solver pack 7 "
        self.interpreterQuickHelp = "Specify the use of the steady-state solver pack 7"
        self.interpreterLongHelp = "Specify the use of the steady-state solver pack 7"
