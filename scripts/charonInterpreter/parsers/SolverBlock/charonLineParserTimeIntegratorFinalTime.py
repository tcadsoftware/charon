...
class charonLineParserTimeIntegratorFinalTime:
    "TimeIntegratorFinalTime parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TimeIntegratorFinalTime"
        self.parsingKey = "time integrator final time"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "time integrator final time = {time} "
        self.interpreterQuickHelp = "Specify the time integrator final time"
        self.interpreterLongHelp = "Specify the time integrator final time in seconds"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->Rythmos,Final Time,double,{time}")
        ...
        self.xmlRequiredArgument.append("{time}")
