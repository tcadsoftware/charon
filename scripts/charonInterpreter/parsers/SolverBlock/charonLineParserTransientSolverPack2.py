...
class charonLineParserTransientSolverPack2:
    "TransientSolverPack2 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TransientSolverPack2"
        self.parsingKey = "use transient solver pack 2"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use transient solver pack 2 "
        self.interpreterQuickHelp = "Specify the use of the transient solver pack 2"
        self.interpreterLongHelp = "Specify the use of the transient solver pack 2 (backward Euler)"
        ...
        self.xmlDefaultLines.append("Charon->Solution Control->Rythmos,Final Time,double,5e-5")
        self.xmlDefaultLines.append("Charon->Solution Control->Rythmos,Stepper Type,string,Backward Euler")
        self.xmlDefaultLines.append("Charon->Solution Control->Rythmos->Rythmos Stepper->VerboseObject,Verbosity Level,string,none")
        self.xmlDefaultLines.append("Charon->Solution Control->Rythmos->Rythmos Integration Control,Take Variable Steps,bool,false")
