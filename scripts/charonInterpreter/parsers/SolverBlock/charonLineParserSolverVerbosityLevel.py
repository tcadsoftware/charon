...
class charonLineParserSolverVerbosityLevel:
    "SolverVerbosityLevel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SolverVerbosityLevel"
        self.parsingKey = "verbosity level is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("low")
        self.parsingKeyOptional.append("medium")
        self.parsingKeyOptional.append("high")
        self.parsingKeyOptional.append("extreme")
        self.interpreterHelpLine = "verbosity level is [ low [ medium [ high [ extreme ]]]] "
        self.interpreterQuickHelp = "How much output to produce to show the progress of the solvers."
        self.interpreterLongHelp = "How much output to produce to show the progress of the solvers."
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->Belos->VerboseObject,Verbosity Level,string,low")
        self.xmlOptionalLines[0].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack2->VerboseObject,Verbosity Level,string,low")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->Belos->VerboseObject,Verbosity Level,string,medium")
        self.xmlOptionalLines[1].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack2->VerboseObject,Verbosity Level,string,medium")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->Belos->VerboseObject,Verbosity Level,string,high")
        self.xmlOptionalLines[2].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack2->VerboseObject,Verbosity Level,string,high")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[3].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Linear Solver Types->Belos->VerboseObject,Verbosity Level,string,extreme")
        self.xmlOptionalLines[3].append(" Charon->Solution Control->NOX->Direction->Newton->Stratimikos Linear Solver->Stratimikos->Preconditioner Types->Ifpack2->VerboseObject,Verbosity Level,string,extreme")
