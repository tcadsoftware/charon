...
class charonLineParserConcentrationScaling:
    "ConcentrationScaling parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ConcentrationScaling"
        self.parsingKey = "concentration scaling"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "concentration scaling = {scaling} "
        self.interpreterQuickHelp = "Set the concentration scaling "
        self.interpreterLongHelp = " Set the concentration scaling <> scaling is the scaling value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models,Concentration Scaling,double,{scaling}")
        ...
        self.xmlRequiredArgument.append("{scaling}")
        ...
        self.xmlDefaultLines.append("Charon->Closure Models,Concentration Scaling,double,1.0e16")
