...
class charonLineParserPulseStartTime:
    "PulseStartTime parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PulseStartTime"
        self.parsingKey = "pulse start time"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Pulse start time = {startTime} "
        self.interpreterQuickHelp = "set the onset time of the pulse in s"
        self.interpreterLongHelp = "set the onset time of the pulse in s"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,pulse start,double,{startTime}")
        ...
        self.xmlRequiredArgument.append("{startTime}")
