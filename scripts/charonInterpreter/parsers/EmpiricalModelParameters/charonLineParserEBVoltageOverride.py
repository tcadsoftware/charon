...
class charonLineParserEBVoltageOverride:
    "EBVoltageOverride parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EBVoltageOverride"
        self.parsingKey = "emitter-base voltage override"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "emitter-base voltage override = {voltage} "
        self.interpreterQuickHelp = "This sets the voltage across the emitter base junction to a specific value for interpolating from the mu tables."
        self.interpreterLongHelp = "This sets the voltage across the emitter base junction to a specific value for interpolating from the mu tables. <> This is mostly used in testing."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,eb voltage override,double,{voltage}")
