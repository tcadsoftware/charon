...
class charonLineParserCrossSection:
    ...
    def __init__(self):
        ...
        self.parsingKey = "cross section"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Cross section = {cs} "
        self.interpreterQuickHelp = "set the cross section in cm^2"
        self.interpreterLongHelp = "set the cross section in cm^2"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,cross section,double,{cs}")
        ...
        self.xmlRequiredArgument.append("{cs}")
