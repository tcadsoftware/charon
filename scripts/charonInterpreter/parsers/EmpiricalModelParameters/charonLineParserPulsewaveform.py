...
class charonLineParserPulsewaveform:
    "Pulsewaveform parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Pulsewaveform"
        self.parsingKey = "pulse waveform is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("gaussian")
        self.interpreterHelpLine = "Pulse waveform is [ gaussian] "
        self.interpreterQuickHelp = "set the shape of the neutron pulse waveform"
        self.interpreterLongHelp = "Set the shape of hte neutron pulse waveform <> options are gaussian"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->Empirical Defect Recombination,pulse type,string,gaussian")
