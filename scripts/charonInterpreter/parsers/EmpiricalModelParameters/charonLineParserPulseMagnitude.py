...
class charonLineParserPulseMagnitude:
    "PulseMagnitude parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PulseMagnitude"
        self.parsingKey = "pulse magnitude"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "pulse magnitude = {pulseMag} "
        self.interpreterQuickHelp = "set the maximum value of the pulse"
        self.interpreterLongHelp = "set the maximum value of the pulse <> This the maximum rate of Frenkel pair prodution through the lifetime of the pulse"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,pulse magnitude,double,{pulseMag}")
        ...
        self.xmlRequiredArgument.append("{pulseMag}")
