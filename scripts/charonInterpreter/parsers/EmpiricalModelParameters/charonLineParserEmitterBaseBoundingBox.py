...
class charonLineParserEmitterBaseBoundingBox:
    "EmitterBaseBoundingBox parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EmitterBaseBoundingBox"
        self.parsingKey = "emitter base junction bounding box"
        ...
        self.interpreterHelpLine = "emitter base junction bounding box is {locMin} to {locMax} [ in x [ in y [ in z]]] "
        self.interpreterQuickHelp = "Set the coordinate range of the bounding box in x  y or z"
        self.interpreterLongHelp = "Set the coordinate range of the bounding box in x  y or z <> units are microns <> This is the bounding box in which the recombination from annealing occurs."
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->Empirical Defect Recombination,eb x low,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->Empirical Defect Recombination,eb x high,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->Empirical Defect Recombination,eb y low,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->Empirical Defect Recombination,eb y high,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->Empirical Defect Recombination,eb z low,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->Empirical Defect Recombination,eb z high,double,{locMax}")
