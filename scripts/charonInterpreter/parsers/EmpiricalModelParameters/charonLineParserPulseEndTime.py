...
class charonLineParserPulseEndTime:
    "PulseEndTime parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PulseEndTime"
        self.parsingKey = "pulse end time"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Pulse end time = {endTime} "
        self.interpreterQuickHelp = "set the end time of the pulse in s"
        self.interpreterLongHelp = "set the end time of the pulse in s"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,pulse end,double,{endTime}")
        ...
        self.xmlRequiredArgument.append("{endTime}")
