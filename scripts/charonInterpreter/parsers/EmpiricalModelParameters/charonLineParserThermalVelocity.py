...
class charonLineParserThermalVelocity:
    "ThermalVelocity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ThermalVelocity"
        self.parsingKey = "thermal velocity"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Thermal velocity = {tv} "
        self.interpreterQuickHelp = "set the thermal velocity in cm/s"
        self.interpreterLongHelp = "set the thermal velocity in cm/s"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Empirical Defect Recombination,thermal velocity,double,{tv}")
        ...
        self.xmlRequiredArgument.append("{tv}")
