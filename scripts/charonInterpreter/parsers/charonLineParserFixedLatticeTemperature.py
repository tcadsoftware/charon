...
class charonLineParserFixedLatticeTemperature:
    "FixedLatticeTemperature parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "FixedLatticeTemperature"
        self.parsingKey = "lattice temperature"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "lattice temperature = {temp} "
        self.interpreterQuickHelp = "Set a fixed lattice temperature "
        self.interpreterLongHelp = " Set a fixed lattice temperature <> temp is the temperature"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models,Lattice Temperature,double,{temp}")
        ...
        self.xmlRequiredArgument.append("{temp}")
        ...
        self.xmlDefaultLines.append("Charon->Closure Models,Lattice Temperature,double,300")
