...
class charonLineParsercreateUseTpetra:
    "createUseTpetra parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "createUseTpetra"
        self.parsingKey = "tpetra is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("on")
        self.parsingKeyOptional.append("off")
        self.interpreterHelpLine = "tpetra is [ on [ off ]] "
        self.interpreterQuickHelp = "Use tpetra  otherwise use epetra."
        self.interpreterLongHelp = "Use tpetra  otherwise use epetra."
        ...
        self.xmlOptionalLines[0].append("  Charon->Assembly,Use Tpetra,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Assembly,Use Tpetra,bool,false")
        ...
        self.xmlDefaultLines.append("Charon->Assembly,Use Tpetra,bool,false")
