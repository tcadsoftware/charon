...
class charonLineParserBulkFixedCharge:
    "BulkFixedCharge parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BulkFixedCharge"
        self.parsingKey = "bulk fixed charge"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Bulk fixed charge [ is on [ is off]] "
        self.interpreterQuickHelp = "Toggle bulk fixed charge"
        self.interpreterLongHelp = "Toggle bulk fixed charge <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Fixed Charge,string,True")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Fixed Charge,string,False")
