...
class charonLineParserPecletLengthScale:
    "PecletLengthScale parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PecletLengthScale"
        self.parsingKey = "supg length scale is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("stream")
        self.parsingKeyOptional.append("shakib")
        self.interpreterHelpLine = "supg length scale is [stream [shakib]] "
        self.interpreterQuickHelp = "Specify the length scale to be used in the supg stabilization"
        self.interpreterLongHelp = "Specify the length scale to be used in the supg stabilization <> Options are stream or shakib"
        ...
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Length Scale,string,Shakib")
