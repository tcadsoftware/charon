...
class charonLineParserOpticalGeneration:
    "OpticalGeneration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OpticalGeneration"
        self.parsingKey = "optical generation"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Optical Generation [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on optical generation"
        self.interpreterLongHelp = "Turn on optical generation <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Optical Generation,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Optical Generation,string,Off")
