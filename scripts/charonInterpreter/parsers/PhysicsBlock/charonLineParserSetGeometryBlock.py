...
class charonLineParserSetGeometryBlock:
    "SetGeometryBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SetGeometryBlock"
        self.parsingKey = "geometry block"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "geometry block is {geometryBlock} "
        self.interpreterQuickHelp = "Set the geometry block for this phycics description"
        self.interpreterLongHelp = "Set the geometry block for this phycics description <> {geometryBlock} is the corresponding block name as set when the mesh was created"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Block ID to Physics ID Mapping,{geometryBlock},string,{physicsBlockName}")
