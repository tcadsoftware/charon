...
class charonLineParserRadiativeRecombination:
    "RadiativeRecombination parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "RadiativeRecombination"
        self.parsingKey = "radiative recombination"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Radiative Recombination [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on radiative recombination"
        self.interpreterLongHelp = "Turn on radiative recombination <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Radiative,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Radiative,string,Off")
