...
class charonLineParserIncompleteIonizationDonor:
    "IncompleteIonizationDonor parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "IncompleteIonizationDonor"
        self.parsingKey = "donor incomplete ionization"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "donor incomplete ionization [ is on [ is off ]] "
        self.interpreterQuickHelp = "Specify incomplete ionization of dopant type donor."
        self.interpreterLongHelp = "Enable incomplete ionization model of donor type  with parameters specified in the Incomplete Ionization Acceptor block of the Material Block."
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->Semiconductor->ANONYMOUS->Options,Donor Incomplete Ionization,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->Semiconductor->ANONYMOUS->Options,Donor Incomplete Ionization,string,Off")
