...
class charonLineParserSetMaterialModel:
    "SetMaterialModel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SetMaterialModel"
        self.parsingKey = "material model"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "material model is {materialModelName} "
        self.interpreterQuickHelp = "Specifies the material model to be used with this physics block"
        self.interpreterLongHelp = "Specifies the material model to be used with this physics block <> materialModelName must be a name that corresponds to an equally named material model block in this input."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS,Model ID,string,{materialModelName}")
        ...
        self.xmlRequiredArgument.append("{materialModelName}")
