...
class charonLineParserTrapCharge:
    "TrapCharge parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TrapCharge"
        self.parsingKey = "trap charge"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "trap charge [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on the trap charge"
        self.interpreterLongHelp = "Turn on the trap charge <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Add Trap Charge,string,True")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Add Trap Charge,string,False")
