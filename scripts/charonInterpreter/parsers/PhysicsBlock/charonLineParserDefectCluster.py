...
class charonLineParserDefectCluster:
    "DefectCluster parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DefectCluster"
        self.parsingKey = "defect cluster"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "defect cluster [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on defect clusters"
        self.interpreterLongHelp = "Turn on defect clusters <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Defect Cluster,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Defect Cluster,string,Off")
