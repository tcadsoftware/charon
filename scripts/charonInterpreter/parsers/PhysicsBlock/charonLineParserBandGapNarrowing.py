...
class charonLineParserBandGapNarrowing:
    "BandGapNarrowing parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BandGapNarrowing"
        self.parsingKey = "band gap narrowing"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "band gap narrowing [ is on [ is off] ] "
        self.interpreterQuickHelp = "Turn on band gap narrowing"
        self.interpreterLongHelp = "Turn on band gap narrowing"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Band Gap Narrowing,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Band Gap Narrowing,string,Off")
