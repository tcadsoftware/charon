...
class charonLineParserAugerRecombination:
    "AugerRecombination parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AugerRecombination"
        self.parsingKey = "auger recombination"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Auger recombination [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on Auger recombination"
        self.interpreterLongHelp = "Turn on Auger recombination <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Auger,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Auger,string,Off")
