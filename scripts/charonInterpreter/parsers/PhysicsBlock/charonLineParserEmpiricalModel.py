...
class charonLineParserEmpiricalModel:
    "EmpiricalModel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EmpiricalModel"
        self.parsingKey = "empirical damage model"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "empirical damage model [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on empirical model for neutron irradiation annealing"
        self.interpreterLongHelp = "Turn on empirical model for neutron irradiation annealing <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Empirical Defect,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Empirical Defect,string,Off")
