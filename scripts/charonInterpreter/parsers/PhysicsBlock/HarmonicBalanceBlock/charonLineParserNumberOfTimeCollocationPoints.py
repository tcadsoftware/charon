...
class charonLineParserNumberOfTimeCollocationPoints:
    "NumberOfTimeCollocationPoints parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NumberOfTimeCollocationPoints"
        self.parsingKey = "number of time collocation points"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "number of time collocation points = {numPoints} "
        self.interpreterQuickHelp = "Set the number of time collocation points for the harmonic balance method."
        self.interpreterLongHelp = "Set the number of time collocation points for the harmonic balance method. {numPoints} must be a positive integer."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("(number of time collocation points) Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Number of Time Collocation Points,int,{numPoints}")
        ...
        self.xmlRequiredArgument.append("{numPoints}")
