...
class charonLineParserRemappedFundamentalHarmonics:
    "RemappedFundamentalHarmonics parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "RemappedFundamentalHarmonics"
        self.parsingKey = "remapped fundamental harmonics"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "remapped fundamental harmonics = {remappedFundamentalHarmonics} "
        self.interpreterQuickHelp = "Set the remapped fundamental harmonics for the harmonic balance method."
        self.interpreterLongHelp = "Set the remapped fundamental harmonics for the harmonic balance method. {remappedFundamentalHarmonics} must be a list of frequencies separated by commas."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("(remapped fundamental harmonics) Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Remapped Fundamental Harmonics,Array(double),{remappedFundamentalHarmonics}")
        ...
        self.xmlRequiredArgument.append("{remappedFundamentalHarmonics}")
