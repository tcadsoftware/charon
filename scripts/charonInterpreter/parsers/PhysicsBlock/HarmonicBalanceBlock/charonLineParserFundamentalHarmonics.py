...
class charonLineParserFundamentalHarmonics:
    "FundamentalHarmonics parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "FundamentalHarmonics"
        self.parsingKey = "fundamental harmonics"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "fundamental harmonics = {fundamentalHarmonics} "
        self.interpreterQuickHelp = "Set the fundamental harmonics for the harmonic balance method."
        self.interpreterLongHelp = "Set the fundamental harmonics for the harmonic balance method. {fundamentalHarmonics} must be a list of frequencies separated by commas."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("(fundamental harmonics) Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Fundamental Harmonics,Array(double),{{fundamentalHarmonics}}")
        ...
        self.xmlRequiredArgument.append("{fundamentalHarmonics}")
