...
class charonLineParserHybridExponent:
    "HybridExponent parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HybridExponent"
        self.parsingKey = "hybrid exponent"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hybrid exponent = {hybridExponent} "
        self.interpreterQuickHelp = "Set the hybrid exponent of the harmonic balance method."
        self.interpreterLongHelp = "Set the hybrid exponent of the harmonic balance method. {hybridExponent} must be a value between 0 and 1  interpolating between the box and diamond truncation schemes."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("(hybrid exponent) Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Hybrid Exponent,double,{hybridExponent}")
        ...
        self.xmlRequiredArgument.append("{hybridExponent}")
