...
class charonLineParserTruncationOrder:
    "TruncationOrder parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TruncationOrder"
        self.parsingKey = "truncation order"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "truncation order = {truncationOrder} "
        self.interpreterQuickHelp = "Set the truncation order of the harmonic balance method."
        self.interpreterLongHelp = "Set the truncation order of the harmonic balance method. {truncationOrder} must be a positive integer."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("(truncation order) Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Truncation Order,int,{truncationOrder}")
        ...
        self.xmlRequiredArgument.append("{truncationOrder}")
