...
class charonLineParserTruncationScheme:
    "TruncationScheme parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TruncationScheme"
        self.parsingKey = "truncation scheme"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("box")
        self.parsingKeyOptional.append("diamond")
        self.interpreterHelpLine = "truncation scheme is [box [diamond]] "
        self.interpreterQuickHelp = "Set the truncation scheme of the harmonic balance method."
        self.interpreterLongHelp = "Set the truncation scheme of the harmonic balance method. {truncationScheme} can be 'Box' or 'Diamond'."
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Truncation Scheme,string,Box")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Frequency Domain Options,Truncation Scheme,string,Diamond")
