...
class charonLineParserSRHRecombination:
    "SRHRecombination parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SRHRecombination"
        self.parsingKey = "srh recombination"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "SRH Recombination [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on SRH recombination"
        self.interpreterLongHelp = "Turn on SRH recombination <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,SRH,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,SRH,string,Off")
