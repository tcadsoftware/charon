...
class charonLineParserAvalancheGen:
    "AvalancheGen parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AvalancheGen"
        self.parsingKey = "avalanche"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Avalanche [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on avalanche generation"
        self.interpreterLongHelp = "Turn on avalanche generation <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Avalanche,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Avalanche,string,Off")
