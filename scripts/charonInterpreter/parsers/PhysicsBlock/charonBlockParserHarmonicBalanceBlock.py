...
class charonBlockParserHarmonicBalanceBlock:
    "HarmonicBalanceBlock parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start harmonic balance parameters"
        self.parserBlockName = "HarmonicBalanceBlock"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start harmonic balance parameters "
