...
class charonLineParserSUPGStabilizationToggle:
    "SUPGStabilizationToggle parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SUPGStabilizationToggle"
        self.parsingKey = "supg stabilization"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("on")
        self.parsingKeyOptional.append("off")
        self.interpreterHelpLine = "SUPG Stabilization is [on [ off ]] "
        self.interpreterQuickHelp = "Toggle SUPG Stabilization 'On' or 'Off'."
        self.interpreterLongHelp = "Toggle SUPG Stabilization 'On' or 'Off'."
        ...
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,SUPG Stabilization,string,Off")
        self.xmlOptionalLinePriority[0].append(5)
        self.xmlOptionalLinePriority.append([])
        self.xmlOptionalLinePriority[1].append(5)
