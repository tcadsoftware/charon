...
class charonLineParserDrivingForce:
    ...
    def __init__(self):
        ...
        self.parsingKey = "driving force"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("gradient quasi fermi level")
        self.parsingKeyOptional.append("effective field")
        self.parsingKeyOptional.append("gradient potential")
        self.interpreterHelpLine = "Driving Force is [ gradient quasi fermi level [ effective field [ gradient potential ]]] "
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Driving Force,string,GradQuasiFermi")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Driving Force,string,EffectiveField")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Driving Force,string,GradPotential")
