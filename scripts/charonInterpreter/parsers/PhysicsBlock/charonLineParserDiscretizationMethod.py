...
class charonLineParserDiscretizationMethod:
    ...
    def __init__(self):
        ...
        self.parsingKeyOptional.append("is fem-effpg")
        self.parsingKeyOptional.append("is fem-supg")
        self.parsingKeyOptional.append("cvfem-sg")
        self.interpreterHelpLine = "discretization method [ is FEM-EFFPG [ is FEM-SUPG [ CVFEM-SG ]]] "
        self.interpreterQuickHelp = "Select discretization method"
        self.interpreterLongHelp = "Select discretization method"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Discretization Method,string,FEM-EFFPG")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Discretization Method,string,FEM-SUP")
        self.xmlOptionalLines.append([])
