...
class charonLineParserIncompleteIonizationAcceptor:
    "IncompleteIonizationAcceptor parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "IncompleteIonizationAcceptor"
        self.parsingKey = "acceptor incomplete ionization"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "acceptor incomplete ionization [ is on [ is off ]] "
        self.interpreterQuickHelp = "Specify incomplete ionization of dopant type acceptor."
        self.interpreterLongHelp = "Enable incomplete ionization model of acceptor type  with parameters specified in the Incomplete Ionization Acceptor block of the Material Block."
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->Semiconductor->ANONYMOUS->Options,Acceptor Incomplete Ionization,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->Semiconductor->ANONYMOUS->Options,Acceptor Incomplete Ionization,string,Off")
