...
class charonLineParserTrapSRH:
    "TrapSRH parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TrapSRH"
        self.parsingKey = "trap srh"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "trap srh [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on the trap srh model"
        self.interpreterLongHelp = "Turn on trap srh model <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Trap SRH,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Trap SRH,string,Off")
