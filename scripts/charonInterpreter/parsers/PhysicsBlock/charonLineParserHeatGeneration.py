...
class charonLineParserHeatGeneration:
    "HeatGeneration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HeatGeneration"
        self.parsingKey = "heat generation"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "heat generation is analytic "
        self.interpreterQuickHelp = "Turn on analytic heat generation for lattice gfem"
        self.interpreterLongHelp = "Turn on analytic heat generation for lattice gfem"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Heat Generation,string,Analytic")
