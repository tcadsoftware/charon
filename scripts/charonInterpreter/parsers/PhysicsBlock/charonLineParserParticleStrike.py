...
class charonLineParserParticleStrike:
    "ParticleStrike parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ParticleStrike"
        self.parsingKey = "particle strike"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "particle strike [ is on [ is off]] "
        self.interpreterQuickHelp = "Turn on particle strike"
        self.interpreterLongHelp = "Turn on particle strike <> {State} is On/Off"
        ...
        self.xmlOptionalLines[0].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Particle Strike,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS->Options,Particle Strike,string,Off")
