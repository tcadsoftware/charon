...
class charonLineParserDiscontinuity:
    "Discontinuity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Discontinuity"
        self.parsingKey = "discontinuity for hbt"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "discontinuity for hbt with suffix {discSuffix} "
        self.interpreterQuickHelp = "For heterojunction bipolar transistors enable support for the discontinuity at the emitter-base junction"
        self.interpreterLongHelp = "For heterojunction bipolar transistors enable support for the discontinuity at the emitter-base junction"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS,Discontinuous Fields,string,ELECTRON_DENSITY,HOLE_DENSITY,Doping,Electron Effective DOS,Hole Effective DOS")
        self.xmlRequiredLines.append("Charon->Physics Blocks->{physicsBlockName}->ANONYMOUS,Discontinuous Suffix,string,{discSuffix}")
        ...
        self.xmlRequiredArgument.append("{discSuffix}")
