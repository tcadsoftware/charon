...
class charonBlockParserSweepOptions:
    "SweepOptions parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start sweep options"
        self.parserBlockName = "SweepOptions"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Sweep Options "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Solution Control->LOCA->Stepper,Continuation Method,string,Natural")
