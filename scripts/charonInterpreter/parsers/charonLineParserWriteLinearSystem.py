...
class charonLineParserWriteLinearSystem:
    "WriteLinearSystem parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "WriteLinearSystem"
        self.parsingKey = "write linear system"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "write linear system [is on [is off]] "
        self.interpreterQuickHelp = "Set a flag to write out the linear system at each Newton iteration."
        self.interpreterLongHelp = "Set a flag to write out the linear system at each Newton iteration."
        ...
        self.xmlOptionalLines[0].append(" Charon->Solver Factories->NOX Observers,Write Linear System,string,ON")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solver Factories->NOX Observers,Write Linear System,string,OFF")
