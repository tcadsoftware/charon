...
class charonBlockParserEmpiricalModelParameters:
    "EmpiricalModelParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start empirical model parameters"
        self.parserBlockName = "EmpiricalModelParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Empirical Model Parameters "
