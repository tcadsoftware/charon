...
class charonBlockParserSurfaceChargeBC:
    "SurfaceChargeBC parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start surface charge bc for"
        self.parserBlockName = "SurfaceChargeBC"
        ...
        self.interpreterBlockHelpLine = "start Surface Charge BC for {sidesetID} "
        ...
        self.xmlDefaultLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS,Type,string,Neumann")
        self.xmlDefaultLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS,Equation Set Name,string,ALL_DOFS")
        self.xmlDefaultLines.append("Charon->Boundary Conditions->{sidesetID}ANONYMOUS,Strategy,string,Neumann Surface Charge")
