...
class charonBlockParserGaAsMobility:
    "GaAsMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start gaas mobility"
        self.parserBlockName = "GaAsMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start GaAs mobility "
