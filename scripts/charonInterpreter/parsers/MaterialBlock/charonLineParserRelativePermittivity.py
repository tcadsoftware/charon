...
class charonLineParserRelativePermittivity:
    "RelativePermittivity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "RelativePermittivity"
        self.parsingKey = "relative permittivity"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "relative permittivity = {relPerm} "
        self.interpreterQuickHelp = "Sets the relative permittivity for the material in this material block"
        self.interpreterLongHelp = "Sets the relative permittivity for the material in this material block <> relPerm is the value of the relative permittivity"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Relative Permittivity,Value,double,{relPerm}")
        ...
        self.xmlRequiredArgument.append("{relPerm}")
