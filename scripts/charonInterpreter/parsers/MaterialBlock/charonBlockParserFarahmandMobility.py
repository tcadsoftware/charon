...
class charonBlockParserFarahmandMobility:
    "FarahmandMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start farahmand mobility"
        self.parserBlockName = "FarahmandMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Farahmand Mobility "
