...
class charonBlockParserParticleStrikeParameters:
    "ParticleStrikeParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start particle strike parameters"
        self.parserBlockName = "ParticleStrikeParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start particle strike parameters "
