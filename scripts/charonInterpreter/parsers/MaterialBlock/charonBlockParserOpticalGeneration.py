...
class charonBlockParserOpticalGeneration:
    "OpticalGeneration parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start optical generation named"
        self.parserBlockName = "OpticalGeneration"
        ...
        self.interpreterBlockHelpLine = "start optical generation named {functionName} "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation,Value,string,Function")
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Function Type,string,File")
