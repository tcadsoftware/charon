...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Sets the exponent for hole mobility"
        self.interpreterLongHelp = "Sets the exponent for hole mobility"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Hole Mobility,alpha,double,{alpha}")
