...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.parsingKey = "exponent for mobility"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "exponent for mobility = {alpha} "
        self.interpreterQuickHelp = "Sets the exponent for electron mobility"
        self.interpreterLongHelp = "Sets the exponent for electron mobility"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,alpha,double,{alpha}")
