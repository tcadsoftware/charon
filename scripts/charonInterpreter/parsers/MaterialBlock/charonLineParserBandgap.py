...
class charonLineParserBandgap:
    "Bandgap parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Bandgap"
        self.parsingKey = "bandgap"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "bandgap = {bgval} "
        self.interpreterQuickHelp = "Sets bandgap for the material in this material block"
        self.interpreterLongHelp = "Sets the bandgap for the material in this material block <> bgval is the value of the bandgap"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,Value,double,{bgval}")
        ...
        self.xmlRequiredArgument.append("{bgval}")
