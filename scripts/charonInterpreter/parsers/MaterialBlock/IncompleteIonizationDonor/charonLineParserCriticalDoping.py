...
class charonLineParserCriticalDoping:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Specify incomplete ionization for donor."
        self.interpreterLongHelp = "Specify incomplete ionization for donor."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Donor->Model,Critical Doping Value,double,{valueCriticalDoping}")
