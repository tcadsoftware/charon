...
class charonLineParserApproximationType:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Specify approximation type for donor dopant type."
        self.interpreterLongHelp = "Specify approximation type for donor dopant type."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Donor->Model,Approximation,string,{approximationType}")
