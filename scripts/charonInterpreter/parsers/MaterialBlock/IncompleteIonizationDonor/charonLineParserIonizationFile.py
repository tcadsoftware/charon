...
class charonLineParserIonizationFile:
    "IonizationFile parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "IonizationFile"
        self.parsingKey = "file"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "file is {fileName} "
        self.interpreterQuickHelp = "Specify a file for ionization energies"
        self.interpreterLongHelp = "Specify a file for ionization energies"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Donor->Model,DonIncmplIoniz File,string,{fileName}")
