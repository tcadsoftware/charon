...
class IncompleteIonizationDonorParserLib:
    "This is the  IncompleteIonizationDonorParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "IncompleteIonizationDonorParserLib"
