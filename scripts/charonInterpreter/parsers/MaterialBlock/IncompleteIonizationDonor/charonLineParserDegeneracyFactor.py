...
class charonLineParserDegeneracyFactor:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Specify degeneracy factor for donor dopant type."
        self.interpreterLongHelp = "Specify degeneracy factor for donor dopant type."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Donor->Model,Degeneracy Factor,double,{valueDegeneracyFactor}")
