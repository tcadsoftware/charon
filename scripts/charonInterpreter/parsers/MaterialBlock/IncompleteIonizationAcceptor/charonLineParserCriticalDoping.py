...
class charonLineParserCriticalDoping:
    "CriticalDoping parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CriticalDoping"
        self.parsingKey = "critical doping"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "critical doping = {valueCriticalDoping} "
        self.interpreterQuickHelp = "Specify incomplete ionization for acceptor."
        self.interpreterLongHelp = "Specify incomplete ionization for acceptor."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Acceptor->Model,Critical Doping Value,double,{valueCriticalDoping}")
        ...
        self.xmlRequiredArgument.append("{valueCriticalDoping}")
