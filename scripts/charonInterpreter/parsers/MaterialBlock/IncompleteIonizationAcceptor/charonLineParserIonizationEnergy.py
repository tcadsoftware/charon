...
class charonLineParserIonizationEnergy:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Specify incomplete ionization energy for acceptor dopant type."
        self.interpreterLongHelp = "Specify incomplete ionization energy for acceptor dopant type."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Acceptor->Model,Ionization Energy,double,{valueIonizationEnergy}")
