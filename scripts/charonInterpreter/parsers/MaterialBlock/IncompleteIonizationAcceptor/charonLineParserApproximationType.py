...
class charonLineParserApproximationType:
    "ApproximationType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ApproximationType"
        self.parsingKey = "approximation"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "approximation is {approximationType} "
        self.interpreterQuickHelp = "Specify approximation type for acceptor dopant type."
        self.interpreterLongHelp = "Specify approximation type for acceptor dopant type."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Acceptor->Model,Approximation,string,{approximationType}")
        ...
        self.xmlRequiredArgument.append("{approximationType}")
