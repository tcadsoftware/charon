...
class charonLineParserDegeneracyFactor:
    "DegeneracyFactor parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DegeneracyFactor"
        self.parsingKey = "degeneracy factor"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "degeneracy factor = {valueDegeneracyFactor} "
        self.interpreterQuickHelp = "Specify degeneracy factor for acceptor dopant type."
        self.interpreterLongHelp = "Specify degeneracy factor for acceptor dopant type."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Acceptor->Model,Degeneracy Factor,double,{valueDegeneracyFactor}")
        ...
        self.xmlRequiredArgument.append("{valueDegeneracyFactor}")
