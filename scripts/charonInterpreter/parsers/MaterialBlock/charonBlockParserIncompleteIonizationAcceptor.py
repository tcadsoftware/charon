...
class charonBlockParserIncompleteIonizationAcceptor:
    "IncompleteIonizationAcceptor parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start incomplete ionization acceptor"
        self.parserBlockName = "IncompleteIonizationAcceptor"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Incomplete Ionization Acceptor "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Incomplete Ionized Acceptor,Value,string,Model")
