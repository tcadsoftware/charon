...
class charonBlockParserIntrinsicConc:
    "IntrinsicConc parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start intrinsic concentration"
        self.parserBlockName = "IntrinsicConc"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Intrinsic Concentration "
