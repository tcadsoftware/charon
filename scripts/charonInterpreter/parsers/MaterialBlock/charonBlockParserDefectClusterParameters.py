...
class charonBlockParserDefectClusterParameters:
    "DefectClusterParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start defect cluster parameters"
        self.parserBlockName = "DefectClusterParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start defect cluster parameters "
