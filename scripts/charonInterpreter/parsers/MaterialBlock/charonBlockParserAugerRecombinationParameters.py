...
class charonBlockParserAugerRecombinationParameters:
    "AugerRecombinationParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start auger recombination parameters"
        self.parserBlockName = "AugerRecombinationParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Auger Recombination Parameters "
