...
class charonLineParserMaterialName:
    "MaterialName parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MaterialName"
        self.parsingKey = "material name"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "material name is {materialName} "
        self.interpreterQuickHelp = "Set the Material name "
        self.interpreterLongHelp = " Set the Material name <> materialName is the material in this material block (e.g. Silicon)"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName},Material Name,string,{materialName}")
        ...
        self.xmlRequiredArgument.append("{materialName}")
