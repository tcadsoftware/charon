...
class charonBlockParserLucentMobility:
    "LucentMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start lucent mobility"
        self.parserBlockName = "LucentMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Lucent Mobility "
