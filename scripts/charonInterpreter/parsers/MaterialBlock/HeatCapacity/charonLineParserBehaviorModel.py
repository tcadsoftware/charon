...
class charonLineParserBehaviorModel:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "behavior model is [ tempdep [ powerlawtempdep ]] "
        self.interpreterQuickHelp = "Set behavior model for heat capacity"
        self.interpreterLongHelp = "Set behavior model for heat capacity"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Heat Capacity,Value,string,TempDep")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Heat Capacity,Value,string,PowerLawTempDep")
