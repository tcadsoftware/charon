...
class charonLineParserAParameter:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the parameter a for heat capacity TempDep model"
        self.interpreterLongHelp = "Set the parameter a for heat capacity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,a,double,{aval}")
