...
class charonLineParserc300:
    "c300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "c300"
        self.parsingKey = "c300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "c300 = {cval} "
        self.interpreterQuickHelp = "Set the specific heat at 300K"
        self.interpreterLongHelp = "Set the specific heat at 300"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,c300,double,{cval}")
