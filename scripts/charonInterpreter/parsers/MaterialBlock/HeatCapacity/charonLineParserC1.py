...
class charonLineParserC1:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "c1 = {cval} "
        self.interpreterQuickHelp = "Set the parameter c1"
        self.interpreterLongHelp = "Set the parameter c1 for heat capacity model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,c1,double,{cval}")
