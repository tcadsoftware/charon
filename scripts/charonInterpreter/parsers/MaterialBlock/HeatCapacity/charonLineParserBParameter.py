...
class charonLineParserBParameter:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the parameter b for heat capacity TempDep model"
        self.interpreterLongHelp = "Set the parameter b for heat capacity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,b,double,{bval}")
