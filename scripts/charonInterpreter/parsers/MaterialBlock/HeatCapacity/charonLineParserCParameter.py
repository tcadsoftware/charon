...
class charonLineParserCParameter:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the parameter c for heat capacity TempDep model"
        self.interpreterLongHelp = "Set the parameter c for heat capacity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,c,double,{cval}")
