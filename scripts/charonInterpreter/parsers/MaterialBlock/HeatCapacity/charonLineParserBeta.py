...
class charonLineParserBeta:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the parameter beta"
        self.interpreterLongHelp = "Set the parameter beta for heat capacity model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,beta,double,{betaval}")
