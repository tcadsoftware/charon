...
class charonLineParserMassDensity:
    "MassDensity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MassDensity"
        self.parsingKey = "mass density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "mass density = {mdensval} "
        self.interpreterQuickHelp = "Set the mass density value"
        self.interpreterLongHelp = "Set the mass density value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Capacity,Mass Density,double,{mdensval}")
        ...
        self.xmlRequiredArgument.append("{mdensval}")
