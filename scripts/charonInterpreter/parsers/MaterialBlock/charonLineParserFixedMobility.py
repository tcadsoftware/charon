...
class charonLineParserFixedMobility:
    "FixedMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "FixedMobility"
        self.parsingKey = "fixed mobility"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("electrons")
        self.parsingKeyOptional.append("holes")
        self.interpreterHelpLine = "fixed mobility for [ electrons is {evalue} [ holes is {hvalue} ]] "
        self.interpreterQuickHelp = " Set a fixed mobility value "
        self.interpreterLongHelp = "Set a fixed mobility value <> value is the value "
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Value,double,{evalue}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,Value,double,{hvalue}")
        ...
        self.xmlOptionalArgument = [['{evalue}'], ['{hvalue}']]
