...
class charonBlockParserBandGapNarrowing:
    "BandGapNarrowing parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start band gap narrowing parameters"
        self.parserBlockName = "BandGapNarrowing"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Band Gap Narrowing Parameters "
