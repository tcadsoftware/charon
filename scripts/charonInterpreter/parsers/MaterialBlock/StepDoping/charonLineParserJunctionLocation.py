...
class charonLineParserJunctionLocation:
    "JunctionLocation parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "JunctionLocation"
        self.parsingKey = "junction location"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Junction Location = {location} "
        self.interpreterQuickHelp = "set the location of the step junction"
        self.interpreterLongHelp = "set the location of the step junction <> location is in microns"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping,Junction Location,double,{location}")
        ...
        self.xmlRequiredArgument.append("{location}")
