...
class charonLineParserAcceptorConcentration:
    "AcceptorConcentration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AcceptorConcentration"
        self.parsingKey = "acceptor concentration"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Acceptor Concentration = {concentration} "
        self.interpreterQuickHelp = "set the magnitude of the acceptor dopant concentration"
        self.interpreterLongHelp = "set the magnitude of the acceptor dopant concentration <> concentration is the numerical value in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping,Acceptor Value,double,{concentration}")
        ...
        self.xmlRequiredArgument.append("{concentration}")
