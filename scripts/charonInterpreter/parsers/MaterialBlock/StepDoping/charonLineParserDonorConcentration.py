...
class charonLineParserDonorConcentration:
    "DonorConcentration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DonorConcentration"
        self.parsingKey = "donor concentration"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Donor Concentration = {concentration} "
        self.interpreterQuickHelp = "set the magnitude of the donor dopant concentration"
        self.interpreterLongHelp = "set the magnitude of the donor dopant concentration <> concentration is the numerical value in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping,Donor Value,double,{concentration}")
