...
class charonLineParserJunctionDirection:
    "JunctionDirection parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "JunctionDirection"
        self.parsingKey = "direction"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is x")
        self.parsingKeyOptional.append("is y")
        self.parsingKeyOptional.append("is z")
        self.interpreterHelpLine = "direction [ is x [ is y [ is z ]]] "
        self.interpreterQuickHelp = "The coordinate direction over which the step doping applies (x  y or z)"
        self.interpreterLongHelp = "The coordinate direction over which the step doping applies (x  y or z)"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping,Direction,string,X")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping,Direction,string,Y")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Doping,Direction,string,Z")
