...
class charonLineParserDopantOrder:
    "DopantOrder parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DopantOrder"
        self.parsingKey = "dopant order"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Dopant order is {ordering} "
        self.interpreterQuickHelp = "set the ordering of the dopants through increasing coordinate value  PN or NP"
        self.interpreterLongHelp = "set the ordering of the dopants through increasing coordinate value  PN or NP"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping,Configuration,string,{ordering}")
        ...
        self.xmlRequiredArgument.append("{ordering}")
