...
from .charonLineParserDopingRamp import *



class LinearDopingParserLib:
    "This is the  LinearDopingParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "LinearDopingParserLib"
        ...
        self.lineParsers.append(charonLineParserDopingRamp())
