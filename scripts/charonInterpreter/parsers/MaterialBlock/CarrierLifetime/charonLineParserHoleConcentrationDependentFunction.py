...
class charonLineParserHoleConcentrationDependentFunction:
    "HoleConcentrationDependentFunction parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HoleConcentrationDependentFunction"
        self.parsingKey = "hole lifetime is concentration"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("with nsrh")
        self.interpreterHelpLine = "hole lifetime is concentration dependent [with Nsrh = {Nsrh}] "
        self.interpreterQuickHelp = "Specify that the hole lifetime is concentration dependent."
        self.interpreterLongHelp = "Specify that the hole lifetime is concentration dependent. <> {Nsrh} is the parameter for the function."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Hole Lifetime,Value,string,Function")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Hole Lifetime->Function 1,Function Type,string,ConcDep")
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Hole Lifetime->Function 1,Nsrh,double,{Nsrh}")
