...
class charonLineParserElectronLifetime:
    "ElectronLifetime parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ElectronLifetime"
        self.parsingKey = "electron lifetime is constant"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron lifetime is constant = {lifetime} "
        self.interpreterQuickHelp = "Specify an explicit value for electron lifetime."
        self.interpreterLongHelp = "Specify an explicit value for electron lifetime. <> {lifetime} is the lifetime in seconds."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Lifetime,Value,double,{lifetime}")
        ...
        self.xmlRequiredArgument.append("{lifetime}")
