...
class charonLineParserElectronTemperatureDependentFunction:
    "ElectronTemperatureDependentFunction parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ElectronTemperatureDependentFunction"
        self.parsingKey = "electron lifetime is temperature"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("with exponential function")
        self.interpreterHelpLine = "electron lifetime is temperature dependent [with exponential function] "
        self.interpreterQuickHelp = "Specify that the electon lifetime is temperature dependent."
        self.interpreterLongHelp = "Specify that the electon lifetime is temperature dependent."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Lifetime->Function 2,Function Type,string,TempDep")
