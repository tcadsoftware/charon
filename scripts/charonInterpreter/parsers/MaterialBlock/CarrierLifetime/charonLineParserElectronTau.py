...
class charonLineParserElectronTau:
    "ElectronTau parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ElectronTau"
        self.parsingKey = "electron tau0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron tau0 = {tau} "
        self.interpreterQuickHelp = "Specify a value for tau_0 in the electron lifetime formula."
        self.interpreterLongHelp = "Specify a value for tau_0 in the electron lifetime formula. <> {tau} is the value."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Lifetime,Tau0,double,{tau}")
        ...
        self.xmlRequiredArgument.append("{tau}")
