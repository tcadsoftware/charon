...
class charonLineParserAffinity:
    "Affinity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Affinity"
        self.parsingKey = "electron affinity"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron affinity = {affval} "
        self.interpreterQuickHelp = "Sets the electron affinity for the material in this material block"
        self.interpreterLongHelp = "Sets the electron affinity for the material in this material block <> affval is the value of the electron affinity"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Affinity,Value,double,{affval}")
        ...
        self.xmlRequiredArgument.append("{affval}")
