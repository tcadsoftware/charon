...
class charonBlockParserHeatCapacity:
    "HeatCapacity parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start heat capacity"
        self.parserBlockName = "HeatCapacity"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start heat capacity "
