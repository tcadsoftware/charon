...
class charonBlockParserGaussDoping:
    "GaussDoping parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start gauss doping named"
        self.parserBlockName = "GaussDoping"
        ...
        self.interpreterBlockHelpLine = "start gauss doping named {functionName} "
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Function Type,string,Gauss")
