...
class charonLineParserHighFieldMobility:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Use a high field mobility model for holes"
        self.interpreterLongHelp = "Use a high field mobility model for holes"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Hole Mobility->Bulk Mobility,Enable High Field,bool,true")
