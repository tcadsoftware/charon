...
class HoleBulkPhilipsThomasMobilityParserLib:
    "This is the  HoleBulkPhilipsThomasMobilityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "HoleBulkPhilipsThomasMobilityParserLib"
