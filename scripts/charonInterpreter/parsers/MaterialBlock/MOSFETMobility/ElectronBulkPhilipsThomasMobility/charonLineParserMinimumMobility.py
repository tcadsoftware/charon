...
class charonLineParserMinimumMobility:
    "MinimumMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MinimumMobility"
        self.parsingKey = "minimum mobility"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "minimum mobility = {maxMobility} "
        self.interpreterQuickHelp = "Sets the minimum value for mobility in this mobility model"
        self.interpreterLongHelp = "Sets the minimum value for mobility in this mobility model <> maxMobilty is the maximum numerical value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,mumin,double,{maxMobility}")
