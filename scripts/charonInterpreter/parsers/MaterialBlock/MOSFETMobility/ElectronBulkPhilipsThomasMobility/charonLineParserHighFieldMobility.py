...
class charonLineParserHighFieldMobility:
    ...
    def __init__(self):
        ...
        self.parsingKey = "enable high field mobility"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "enable high field mobility "
        self.interpreterQuickHelp = "Use a high field mobility model for electrons"
        self.interpreterLongHelp = "Use a high field mobility model for electrons"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,Enable High Field,bool,true")
