...
class charonLineParserMaximumMobility:
    "MaximumMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MaximumMobility"
        self.parsingKey = "maximum mobility"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "maximum mobility = {maxMobility} "
        self.interpreterQuickHelp = "Sets the maximum value for mobility in this mobility model"
        self.interpreterLongHelp = "Sets the maximum value for mobility in this mobility model <> maxMobilty is the maximum numerical value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,mumax,double,{maxMobility}")
        ...
        self.xmlRequiredArgument.append("{maxMobility}")
