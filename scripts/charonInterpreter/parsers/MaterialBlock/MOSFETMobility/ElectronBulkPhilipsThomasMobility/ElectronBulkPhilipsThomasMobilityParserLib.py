...
from .charonLineParserKlaassenModel import *
...
class ElectronBulkPhilipsThomasMobilityParserLib:
    "This is the  ElectronBulkPhilipsThomasMobilityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "ElectronBulkPhilipsThomasMobilityParserLib"
        ...
        self.lineParsers.append(charonLineParserKlaassenModel())
