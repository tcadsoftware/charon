...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Sets the alpha value for this mobility model"
        self.interpreterLongHelp = "Sets the alpha value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,alpha,double,{alpha}")
