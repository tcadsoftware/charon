...
class charonLineParserNREF_A:
    "NREF_A parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NREF_A"
        self.parsingKey = "nref_a"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "nref_a = {nref_a} "
        self.interpreterQuickHelp = "Sets the nref_a value for this mobility model"
        self.interpreterLongHelp = "Sets the nref_a value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,nref_a,double,{nref_a}")
        ...
        self.xmlRequiredArgument.append("{nref_a}")
