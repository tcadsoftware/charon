...
class charonLineParserNREF:
    ...
    def __init__(self):
        ...
        self.parsingKey = "nref"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "nref = {nref} "
        self.interpreterQuickHelp = "Sets the nref value for this mobility model"
        self.interpreterLongHelp = "Sets the nref value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,nref,double,{nref}")
