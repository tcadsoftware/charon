...
class charonLineParserCREF_A:
    "CREF_A parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CREF_A"
        self.parsingKey = "cref_a"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "cref_a = {cref_a} "
        self.interpreterQuickHelp = "Sets the cref_a value for this mobility model"
        self.interpreterLongHelp = "Sets the cref_a value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,cref_a,double,{cref_a}")
        ...
        self.xmlRequiredArgument.append("{cref_a}")
