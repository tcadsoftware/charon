...
class charonLineParserNREF_D:
    "NREF_D parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NREF_D"
        self.parsingKey = "nref_d"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "nref_d = {nref_d} "
        self.interpreterQuickHelp = "Sets the nref_d value for this mobility model"
        self.interpreterLongHelp = "Sets the nref_d value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,nref_d,double,{nref_d}")
        ...
        self.xmlRequiredArgument.append("{nref_d}")
