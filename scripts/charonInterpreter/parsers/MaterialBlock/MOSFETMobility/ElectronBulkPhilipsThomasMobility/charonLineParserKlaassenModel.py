...
class charonLineParserKlaassenModel:
    "KlaassenModel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "KlaassenModel"
        self.parsingKey = "use klaassen parameters"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "use klaassen parameters "
        self.interpreterQuickHelp = "Sets the G parameters to Klaassen in the Philips model"
        self.interpreterLongHelp = "Sets the G parameters to Klaassen in the Philips model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,G Parameter Set,string,Klaassen")
