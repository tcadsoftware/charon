...
class charonLineParserGamma:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Sets the gamma value for this mobility model"
        self.interpreterLongHelp = "Sets the gamma value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,gamma,double,{gamma}")
