...
class charonLineParserCREF_D:
    "CREF_D parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CREF_D"
        self.parsingKey = "cref_d"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "cref_d = {cref_d} "
        self.interpreterQuickHelp = "Sets the cref_d value for this mobility model"
        self.interpreterLongHelp = "Sets the cref_d value for this mobility model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility->Bulk Mobility,cref_d,double,{cref_d}")
        ...
        self.xmlRequiredArgument.append("{cref_d}")
