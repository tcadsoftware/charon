...
class charonLineParserMu0:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "Mu0 = {Mu0} "
        self.interpreterQuickHelp = "Set the Mu0 value for Shirahata electron model"
        self.interpreterLongHelp = "Set the Mu0 value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Mu0,double,{Mu0}")
        ...
        self.xmlRequiredArgument.append("{Mu0}")
