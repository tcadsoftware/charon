...
class charonLineParserE1:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "E1 = {E1} "
        self.interpreterQuickHelp = "Set the E1 value for Shirahata electron model"
        self.interpreterLongHelp = "Set the E1 value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,E1,double,{E1}")
        ...
        self.xmlRequiredArgument.append("{E1}")
