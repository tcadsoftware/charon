...
class ElectronShirahataMobilityParserLib:
    "This is the  ElectronShirahataMobilityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "ElectronShirahataMobilityParserLib"
