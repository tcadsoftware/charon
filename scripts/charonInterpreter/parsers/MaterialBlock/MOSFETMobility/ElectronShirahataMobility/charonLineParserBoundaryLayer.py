...
class charonLineParserBoundaryLayer:
    "BoundaryLayer parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BoundaryLayer"
        self.parsingKey = "boundary layer thickness"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "boundary layer thickness = {thickness} "
        self.interpreterQuickHelp = "Set the layer thickness over which this model applies"
        self.interpreterLongHelp = "Set the layer thickness over which this model applies <> Thickness is in microns"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Mobility Boundary Layer,double,{thickness}")
        ...
        self.xmlRequiredArgument.append("{thickness}")
