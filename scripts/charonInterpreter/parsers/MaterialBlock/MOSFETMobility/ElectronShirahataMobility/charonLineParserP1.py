...
class charonLineParserP1:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "P1 = {P1} "
        self.interpreterQuickHelp = "Set the P1 value for Shirahata electron model"
        self.interpreterLongHelp = "Set the P1 value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,P1,double,{P1}")
        ...
        self.xmlRequiredArgument.append("{P1}")
