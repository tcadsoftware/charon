...
class charonLineParserTheta:
    "Theta parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Theta"
        self.parsingKey = "theta"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "theta = {theta} "
        self.interpreterQuickHelp = "Set the theta value for Shirahata electron model"
        self.interpreterLongHelp = "Set the theta value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,theta,double,{theta}")
        ...
        self.xmlRequiredArgument.append("{theta}")
