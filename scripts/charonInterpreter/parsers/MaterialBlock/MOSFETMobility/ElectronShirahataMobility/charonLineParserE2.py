...
class charonLineParserE2:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "E2 = {E2} "
        self.interpreterQuickHelp = "Set the E2 value for Shirahata electron model"
        self.interpreterLongHelp = "Set the E2 value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,E2,double,{E2}")
        ...
        self.xmlRequiredArgument.append("{E2}")
