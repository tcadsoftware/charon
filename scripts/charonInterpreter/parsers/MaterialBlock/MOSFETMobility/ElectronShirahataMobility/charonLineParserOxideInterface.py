...
class charonLineParserOxideInterface:
    "OxideInterface parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OxideInterface"
        self.parsingKey = "spatial range"
        ...
        self.interpreterHelpLine = "spatial range is {locMin} to {locMax} [ in x [ in y [ in z]]] "
        self.interpreterQuickHelp = "Set the start and end coordinate of the oxide interface in x  y or z"
        self.interpreterLongHelp = "Set the start and end coordinate of the oxide interface in x  y or z"
        ...
        self.xmlRequiredArgument.append("{locMin}")
        self.xmlRequiredArgument.append("{locMax}")
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Start X,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,End X,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Start Y,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,End Y,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Start Z,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,End Z,double,{locMax}")
