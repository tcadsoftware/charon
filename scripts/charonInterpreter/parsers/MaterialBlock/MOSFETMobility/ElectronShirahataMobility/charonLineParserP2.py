...
class charonLineParserP2:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "P2 = {P2} "
        self.interpreterQuickHelp = "Set the P2 value for Shirahata electron model"
        self.interpreterLongHelp = "Set the P2 value for Shirahata electron model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,P2,double,{P2}")
        ...
        self.xmlRequiredArgument.append("{P2}")
