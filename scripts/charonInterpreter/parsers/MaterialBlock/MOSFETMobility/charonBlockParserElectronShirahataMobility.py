...
class charonBlockParserElectronShirahataMobility:
    "ElectronShirahataMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start electron channel mobility shirahata"
        self.parserBlockName = "ElectronShirahataMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start electron channel Mobility Shirahata "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models->siliconParameter->Electron Mobility->Perpendicular Field Model,Value,string,Shirahata")
