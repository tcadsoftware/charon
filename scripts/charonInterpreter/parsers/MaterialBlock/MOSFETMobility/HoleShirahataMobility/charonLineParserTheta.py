...
class charonLineParserTheta:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the theta value for Shirahata hole model"
        self.interpreterLongHelp = "Set the theta value for Shirahata hole model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,theta,double,{theta}")
