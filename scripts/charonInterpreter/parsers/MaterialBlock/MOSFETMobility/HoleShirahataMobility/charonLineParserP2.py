...
class charonLineParserP2:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the P2 value for Shirahata hole model"
        self.interpreterLongHelp = "Set the P2 value for Shirahata hole model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,P2,double,{P2}")
