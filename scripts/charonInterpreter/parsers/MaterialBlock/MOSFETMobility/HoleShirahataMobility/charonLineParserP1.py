...
class charonLineParserP1:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the P1 value for Shirahata hole model"
        self.interpreterLongHelp = "Set the P1 value for Shirahata hole model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,P1,double,{P1}")
