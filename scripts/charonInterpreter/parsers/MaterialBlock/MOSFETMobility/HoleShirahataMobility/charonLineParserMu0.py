...
class charonLineParserMu0:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the Mu0 value for Shirahata hole model"
        self.interpreterLongHelp = "Set the Mu0 value for Shirahata hole model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,Mu0,double,{Mu0}")
