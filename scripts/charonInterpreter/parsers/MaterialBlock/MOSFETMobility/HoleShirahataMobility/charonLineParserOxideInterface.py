...
class charonLineParserOxideInterface:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,Start X,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,End X,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,Start Y,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,End Y,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,Start Z,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,End Z,double,{locMax}")
