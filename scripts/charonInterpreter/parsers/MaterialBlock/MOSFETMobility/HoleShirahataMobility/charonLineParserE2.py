...
class charonLineParserE2:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the E2 value for Shirahata hole model"
        self.interpreterLongHelp = "Set the E2 value for Shirahata hole model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->siliconParameter->Hole Mobility->Perpendicular Field Model,E2,double,{E2}")
