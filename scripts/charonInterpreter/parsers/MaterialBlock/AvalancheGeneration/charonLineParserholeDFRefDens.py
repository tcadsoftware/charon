...
class charonLineParserholeDFRefDens:
    "holeDFRefDens parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "holeDFRefDens"
        self.parsingKey = "hole driving force reference density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole driving force reference density = {hDFRefDens} "
        self.interpreterQuickHelp = "Reference hole density for the driving force calculation"
        self.interpreterLongHelp = "Reference hole density for the driving force calculation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,hDrForceRefDens,double,{hDFRefDens}")
        ...
        self.xmlRequiredArgument.append("{hDFRefDens}")
