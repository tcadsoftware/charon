...
class charonBlockParserVanOverstraeten:
    "VanOverstraeten parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start van overstraeten parameters"
        self.parserBlockName = "VanOverstraeten"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start van overstraeten parameters "
