...
class charonLineParserHole_hbaromega:
    "Hole_hbaromega parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_hbaromega"
        self.parsingKey = "hole h bar omega"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole h bar omega = {hbaromega_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,hbarOmega_h,double,{hbaromega_h}")
        ...
        self.xmlRequiredArgument.append("{hbaromega_h}")
