...
class charonLineParserDrivingForce:
    "DrivingForce parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DrivingForce"
        self.parsingKey = "driving force is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("gradient quasi fermi level")
        self.parsingKeyOptional.append("effective field j")
        self.parsingKeyOptional.append("effective field jtot")
        self.parsingKeyOptional.append("gradient potential j")
        self.parsingKeyOptional.append("gradient potential jtot")
        self.interpreterHelpLine = "Driving Force is [ gradient quasi fermi level [ effective field J [ effective field Jtot [ gradient potential J [ gradient potential Jtot ]]]]] "
        self.interpreterQuickHelp = "Set the driving force"
        self.interpreterLongHelp = "Set the driving force"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Driving Force,string,GradQuasiFermi")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Driving Force,string,EffectiveFieldParallelJ")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Driving Force,string,EffectiveFieldParallelJtot")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[3].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Driving Force,string,GradPotentialParallelJ")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[4].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Driving Force,string,GradPotentialParallelJtot")
