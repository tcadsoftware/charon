...
class charonLineParserHole_E0:
    "Hole_E0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_E0"
        self.parsingKey = "hole e0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Hole E0 = {E0_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,E0_h,double,{E0_h}")
        ...
        self.xmlRequiredArgument.append("{E0_h}")
