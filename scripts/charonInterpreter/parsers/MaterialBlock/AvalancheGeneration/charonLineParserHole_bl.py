...
class charonLineParserHole_bl:
    "Hole_bl parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_bl"
        self.parsingKey = "hole b(low)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole blow = {bl_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,bl_h,double,{bl_h}")
        ...
        self.xmlRequiredArgument.append("{bl_h}")
