...
class charonLineParserElectron_delta:
    "Electron_delta parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_delta"
        self.parsingKey = "electron delta"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron delta = {delta_e} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter delta_e for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,delta_e,double,{delta_e}")
        ...
        self.xmlRequiredArgument.append("{delta_e}")
