...
class charonLineParserHole_delta:
    "Hole_delta parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_delta"
        self.parsingKey = "hole delta"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole delta = {delta_h} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter delta_h for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,delta_h,double,{delta_h}")
        ...
        self.xmlRequiredArgument.append("{delta_h}")
