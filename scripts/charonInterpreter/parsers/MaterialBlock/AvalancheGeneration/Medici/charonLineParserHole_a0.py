...
class charonLineParserHole_a0:
    "Hole_a0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_a0"
        self.parsingKey = "hole a0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole a0 = {a0_h} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a0_h for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a0_h,double,{a0_h}")
        ...
        self.xmlRequiredArgument.append("{a0_h}")
