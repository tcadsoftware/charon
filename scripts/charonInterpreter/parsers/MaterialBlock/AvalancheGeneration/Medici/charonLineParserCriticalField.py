...
class charonLineParserCriticalField:
    "CriticalField parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CriticalField"
        self.parsingKey = "critical field"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("fixed")
        self.parsingKeyOptional.append("computed")
        self.interpreterHelpLine = "critical field is [fixed [ computed]] "
        self.interpreterQuickHelp = "Set the critical field computation"
        self.interpreterLongHelp = "Set the critical field computation"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Critical Field,string,Fixed")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Critical Field,string,Computed")
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Critical Field,string,Computed")
