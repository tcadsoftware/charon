...
class charonLineParserElectron_a2:
    "Electron_a2 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_a2"
        self.parsingKey = "electron a2"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron a2 = {a2_e} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a2_e for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a2_e,double,{a2_e}")
        ...
        self.xmlRequiredArgument.append("{a2_e}")
