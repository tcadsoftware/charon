...
class charonLineParserElectron_a0:
    "Electron_a0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_a0"
        self.parsingKey = "electron a0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron a0 = {a0_e} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a0_e for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a0_e,double,{a0_e}")
        ...
        self.xmlRequiredArgument.append("{a0_e}")
