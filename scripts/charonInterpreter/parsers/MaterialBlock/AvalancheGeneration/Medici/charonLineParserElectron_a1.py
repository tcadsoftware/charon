...
class charonLineParserElectron_a1:
    "Electron_a1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_a1"
        self.parsingKey = "electron a1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron a1 = {a1_e} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a1_e for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a1_e,double,{a1_e}")
        ...
        self.xmlRequiredArgument.append("{a1_e}")
