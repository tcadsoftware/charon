...
class charonLineParserHole_a1:
    "Hole_a1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_a1"
        self.parsingKey = "hole a1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole a1 = {a1_h} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a1_h for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a1_h,double,{a1_h}")
        ...
        self.xmlRequiredArgument.append("{a1_h}")
