...
class charonLineParserHole_a2:
    "Hole_a2 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_a2"
        self.parsingKey = "hole a2"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole a2 = {a2_h} "
        self.interpreterQuickHelp = "Parameter for Medici model"
        self.interpreterLongHelp = "Parameter a2_h for Medici model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,a2_h,double,{a2_h}")
        ...
        self.xmlRequiredArgument.append("{a2_h}")
