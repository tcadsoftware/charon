...
class charonLineParserHole_al:
    "Hole_al parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_al"
        self.parsingKey = "hole a(low)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole alow = {al_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,al_h,double,{al_h}")
        ...
        self.xmlRequiredArgument.append("{al_h}")
