...
class charonLineParserElectron_hbaromega:
    "Electron_hbaromega parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_hbaromega"
        self.parsingKey = "electron h bar omega"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron h bar omega = {hbaromega_e} "
        self.interpreterQuickHelp = "Parameter for van Overstraeten model"
        self.interpreterLongHelp = "Parameter for van Overstraeten model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,hbarOmega_e,double,{hbaromega_e}")
        ...
        self.xmlRequiredArgument.append("{hbaromega_e}")
