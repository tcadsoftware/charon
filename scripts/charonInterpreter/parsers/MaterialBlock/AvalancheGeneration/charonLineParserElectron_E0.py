...
class charonLineParserElectron_E0:
    "Electron_E0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_E0"
        self.parsingKey = "electron e0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Electron E0 = {E0_e} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,E0_e,double,{E0_e}")
        ...
        self.xmlRequiredArgument.append("{E0_e}")
