...
class charonLineParserElectron_bh:
    "Electron_bh parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_bh"
        self.parsingKey = "electron b(high)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron bhigh = {bh_e} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,bh_e,double,{bh_e}")
        ...
        self.xmlRequiredArgument.append("{bh_e}")
