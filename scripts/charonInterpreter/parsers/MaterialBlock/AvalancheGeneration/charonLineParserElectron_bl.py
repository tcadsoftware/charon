...
class charonLineParserElectron_bl:
    "Electron_bl parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_bl"
        self.parsingKey = "electron b(low)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron blow = {bl_e} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,bl_e,double,{bl_e}")
        ...
        self.xmlRequiredArgument.append("{bl_e}")
