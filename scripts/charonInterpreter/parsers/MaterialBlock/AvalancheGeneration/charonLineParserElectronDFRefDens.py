...
class charonLineParserElectronDFRefDens:
    "ElectronDFRefDens parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ElectronDFRefDens"
        self.parsingKey = "electron driving force reference density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron driving force reference density = {eDFRefDens} "
        self.interpreterQuickHelp = "Reference electron density for the driving force calculation"
        self.interpreterLongHelp = "Reference electron density for the driving force calculation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,eDrForceRefDens,double,{eDFRefDens}")
        ...
        self.xmlRequiredArgument.append("{eDFRefDens}")
