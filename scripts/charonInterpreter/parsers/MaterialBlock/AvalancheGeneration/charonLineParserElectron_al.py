...
class charonLineParserElectron_al:
    "Electron_al parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_al"
        self.parsingKey = "electron a(low)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron alow = {al_e} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,al_e,double,{al_e}")
        ...
        self.xmlRequiredArgument.append("{al_e}")
