...
class charonLineParserThreshBehavior:
    "ThreshBehavior parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ThreshBehavior"
        self.parsingKey = "threshold behavior model"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("van overstraeten")
        self.parsingKeyOptional.append("okuto")
        self.parsingKeyOptional.append("lackner")
        self.parsingKeyOptional.append("university bologna")
        self.parsingKeyOptional.append("new university bologna")
        self.parsingKeyOptional.append("medici")
        self.parsingKeyOptional.append("crowell-sze")
        self.interpreterHelpLine = "threshold behavior model [ van overstraeten [ okuto [ lackner [ university bologna [ new university bologna [ medici [ crowell-sze ]]]]]]] "
        self.interpreterQuickHelp = "Set the threshold behavior of the ionization coefficients"
        self.interpreterLongHelp = "Set the threshold behavior of the ionization coefficients to the specified model"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,vanOverstraeten")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,Okuto")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,Lackner")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[3].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,UniBo")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[4].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,UniBoNew")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[5].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,Medici")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[6].append(" Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Value,string,Crowell-Sze")
