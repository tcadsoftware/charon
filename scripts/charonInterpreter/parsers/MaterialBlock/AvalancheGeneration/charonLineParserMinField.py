...
class charonLineParserMinField:
    "MinField parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MinField"
        self.parsingKey = "minimum field"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "minimum field = {minF} "
        self.interpreterQuickHelp = "The minimum field for avalanche generation"
        self.interpreterLongHelp = "The minimum field for avalanche generation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Minimum Field,double,{minF}")
        ...
        self.xmlRequiredArgument.append("{minF}")
