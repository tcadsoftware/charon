...
class charonLineParserHole_Ei:
    "Hole_Ei parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_Ei"
        self.parsingKey = "hole ionization energy"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole ionization energy = {Ei_h} "
        self.interpreterQuickHelp = "Parameter for Crowell-Sze model"
        self.interpreterLongHelp = "Parameter Ei_h for Crowell-Sze model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Ei_h,double,{Ei_h}")
        ...
        self.xmlRequiredArgument.append("{Ei_h}")
