...
class charonLineParserHole_lambda300:
    "Hole_lambda300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_lambda300"
        self.parsingKey = "hole lambda300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole lambda300 = {lambda300_h} "
        self.interpreterQuickHelp = "Parameter for Crowell-Sze model"
        self.interpreterLongHelp = "Parameter lambda300_h for Crowell-Sze  model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,lambda300_h,double,{lambda300_h}")
        ...
        self.xmlRequiredArgument.append("{lambda300_h}")
