...
import sys
from .charonLineParserHole_Ei import *
from .charonLineParserElectron_Ei import *
from .charonLineParserHole_lambda300 import *
from .charonLineParserElectron_lambda300 import *
from .charonLineParserE_opt_ph import *



class CrowellSzeParserLib:
    "This is the  CrowellSzeParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "CrowellSzeParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserHole_Ei())
        self.lineParsers.append(charonLineParserElectron_Ei())
        self.lineParsers.append(charonLineParserHole_lambda300())
        self.lineParsers.append(charonLineParserElectron_lambda300())
        self.lineParsers.append(charonLineParserE_opt_ph())
