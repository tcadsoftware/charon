...
class charonLineParserElectron_Ei:
    "Electron_Ei parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_Ei"
        self.parsingKey = "electron ionization energy"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron ionization energy = {Ei_e} "
        self.interpreterQuickHelp = "Parameter for Crowell-Sze model"
        self.interpreterLongHelp = "Parameter Ei_e for Crowell-Sze model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,Ei_e,double,{Ei_e}")
        ...
        self.xmlRequiredArgument.append("{Ei_e}")
