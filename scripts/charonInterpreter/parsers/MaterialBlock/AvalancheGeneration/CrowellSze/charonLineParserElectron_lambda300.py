...
class charonLineParserElectron_lambda300:
    "Electron_lambda300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_lambda300"
        self.parsingKey = "electron lambda300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron lambda300 = {lambda300_e} "
        self.interpreterQuickHelp = "Parameter for Crowell-Sze model"
        self.interpreterLongHelp = "Parameter lambda300_e for Crowell-Sze model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,lambda300_e,double,{lambda300_e}")
        ...
        self.xmlRequiredArgument.append("{lambda300_e}")
