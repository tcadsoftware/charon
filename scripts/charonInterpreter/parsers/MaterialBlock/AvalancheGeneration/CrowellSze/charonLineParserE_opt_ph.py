...
class charonLineParserE_opt_ph:
    "E_opt_ph parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "E_opt_ph"
        self.parsingKey = "optical phonon energy"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "optical phonon energy = {E_opt_ph} "
        self.interpreterQuickHelp = "Parameter for Crowell-Sze model"
        self.interpreterLongHelp = "Parameter E_opt_ph for Crowell-Sze model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,E_opt_ph,double,{E_opt_ph}")
        ...
        self.xmlRequiredArgument.append("{E_opt_ph}")
