...
class charonLineParserHole_ah:
    "Hole_ah parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_ah"
        self.parsingKey = "hole a(high)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole ahigh = {ah_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,ah_h,double,{ah_h}")
        ...
        self.xmlRequiredArgument.append("{ah_h}")
