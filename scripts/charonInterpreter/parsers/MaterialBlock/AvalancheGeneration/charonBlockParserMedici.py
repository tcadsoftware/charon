...
class charonBlockParserMedici:
    "Medici parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start medici parameters"
        self.parserBlockName = "Medici"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start medici parameters "
