...
class charonLineParserHole_bh:
    "Hole_bh parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Hole_bh"
        self.parsingKey = "hole b(high)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "hole bhigh = {bh_h} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,bh_h,double,{bh_h}")
        ...
        self.xmlRequiredArgument.append("{bh_h}")
