...
class charonLineParserElectron_ah:
    "Electron_ah parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Electron_ah"
        self.parsingKey = "electron a(high)"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "electron ahigh = {ah_e} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Avalanche Generation,ah_e,double,{ah_e}")
        ...
        self.xmlRequiredArgument.append("{ah_e}")
