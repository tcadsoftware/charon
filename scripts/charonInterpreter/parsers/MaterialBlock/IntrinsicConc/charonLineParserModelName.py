...
class charonLineParserModelName:
    "ModelName parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ModelName"
        self.parsingKey = "model"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "model = {modelName} "
        self.interpreterQuickHelp = "Specify the intrinsic concentration model name  currently support model = Harmon only"
        self.interpreterLongHelp = "Specify the intrinsic concentration model name  currently support model = Harmon only"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Intrinsic Concentration,Value,string,{modelName}")
        ...
        self.xmlRequiredArgument.append("{modelName}")
