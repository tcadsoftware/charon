...
class charonLineParserApValue:
    "ApValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ApValue"
        self.parsingKey = "ap"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Ap = {ApValue} "
        self.interpreterQuickHelp = "Specify a value for the 'Ap' parameter"
        self.interpreterLongHelp = "Specify a value for the 'Ap' parameter"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Intrinsic Concentration,Ap,double,{ApValue}")
        ...
        self.xmlRequiredArgument.append("{ApValue}")
