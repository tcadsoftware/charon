...
class charonLineParserAnValue:
    "AnValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AnValue"
        self.parsingKey = "an"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "An = {AnValue} "
        self.interpreterQuickHelp = "Specify a value for the 'An' parameter"
        self.interpreterLongHelp = "Specify a value for the 'An' parameter"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Intrinsic Concentration,An,double,{AnValue}")
        ...
        self.xmlRequiredArgument.append("{AnValue}")
