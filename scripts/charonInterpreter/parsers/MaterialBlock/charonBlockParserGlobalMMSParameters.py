...
class charonBlockParserGlobalMMSParameters:
    "GlobalMMSParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start global mms parameters"
        self.parserBlockName = "GlobalMMSParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start global mms parameters "
