...
class charonLineParserExpc:
    "Expc parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Expc"
        self.parsingKey = "expc"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expc = {expcval} "
        self.interpreterQuickHelp = "model parameter expc"
        self.interpreterLongHelp = "Albrecht model parameter expc"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expc,double,{expcval}")
        ...
        self.xmlRequiredArgument.append("{expcval}")
