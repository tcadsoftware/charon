...
class charonLineParserExpN0:
    "ExpN0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ExpN0"
        self.parsingKey = "expn0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expN0 = {expN0val} "
        self.interpreterQuickHelp = "model parameter expN0"
        self.interpreterLongHelp = "Albrecht model parameter expN0"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expN0,double,{expN0val}")
        ...
        self.xmlRequiredArgument.append("{expN0val}")
