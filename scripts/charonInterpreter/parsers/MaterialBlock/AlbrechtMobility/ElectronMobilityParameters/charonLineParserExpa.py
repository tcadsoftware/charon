...
class charonLineParserExpa:
    "Expa parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Expa"
        self.parsingKey = "expa"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expa = {expaval} "
        self.interpreterQuickHelp = "model parameter expa"
        self.interpreterLongHelp = "Albrecht model parameter expa"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expa,double,{expaval}")
        ...
        self.xmlRequiredArgument.append("{expaval}")
