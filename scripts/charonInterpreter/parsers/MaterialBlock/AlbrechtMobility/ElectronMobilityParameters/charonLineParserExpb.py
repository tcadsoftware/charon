...
class charonLineParserExpb:
    "Expb parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Expb"
        self.parsingKey = "expb"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expb = {expbval} "
        self.interpreterQuickHelp = "model parameter expb"
        self.interpreterLongHelp = "Albrecht model parameter expb"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expb,double,{expbval}")
        ...
        self.xmlRequiredArgument.append("{expbval}")
