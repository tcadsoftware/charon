...
class charonLineParserExpT1:
    "ExpT1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ExpT1"
        self.parsingKey = "expt1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expT1 = {expT1val} "
        self.interpreterQuickHelp = "model parameter expT1"
        self.interpreterLongHelp = "Albrecht model parameter expT1"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expT1,double,{expt1val}")
        ...
        self.xmlRequiredArgument.append("{expT1val}")
