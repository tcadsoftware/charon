...
class charonLineParserExpT0:
    "ExpT0 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ExpT0"
        self.parsingKey = "expt0"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "expT0 = {expT0val} "
        self.interpreterQuickHelp = "model parameter expT0"
        self.interpreterLongHelp = "Albrecht model parameter expT0"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,expT0,double,{expT0val}")
        ...
        self.xmlRequiredArgument.append("{expT0val}")
