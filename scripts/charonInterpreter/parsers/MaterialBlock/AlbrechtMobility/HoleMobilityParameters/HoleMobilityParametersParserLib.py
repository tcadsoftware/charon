...
import sys
from .charonLineParserExpb import *
from .charonLineParserExpT1 import *
from .charonLineParserExpN0 import *
from .charonLineParserExpc import *
from .charonLineParserExpa import *
from .charonLineParserExpT0 import *
...
class HoleMobilityParametersParserLib:
    ...
    def __init__(self):
        ...
        self.lineParsers = []
        self.lineParsers.append(charonLineParserExpb())
        self.lineParsers.append(charonLineParserExpT1())
        self.lineParsers.append(charonLineParserExpN0())
        self.lineParsers.append(charonLineParserExpc())
        self.lineParsers.append(charonLineParserExpa())
        self.lineParsers.append(charonLineParserExpT0())
