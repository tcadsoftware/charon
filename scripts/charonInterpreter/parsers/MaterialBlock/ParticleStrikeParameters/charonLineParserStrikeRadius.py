...
class charonLineParserStrikeRadius:
    "StrikeRadius parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "StrikeRadius"
        self.parsingKey = "strike radius"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Strike Radius = {radius} "
        self.interpreterQuickHelp = "set the strike radius in microns"
        self.interpreterLongHelp = "set the strike radius in microns"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Strike Radius,double,{radius}")
        ...
        self.xmlRequiredArgument.append("{radius}")
