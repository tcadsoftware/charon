...
class charonLineParserStrikeTemporalWaveform:
    "StrikeTemporalWaveform parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "StrikeTemporalWaveform"
        self.parsingKey = "strike temporal waveform"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "strike temporal waveform = {waveform} "
        self.interpreterQuickHelp = "set the temporal wave form of the strike"
        self.interpreterLongHelp = "set the  temporal waveform <> options are Gaussian"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Temporal Waveform,string,{waveform}")
        ...
        self.xmlRequiredArgument.append("{waveform}")
