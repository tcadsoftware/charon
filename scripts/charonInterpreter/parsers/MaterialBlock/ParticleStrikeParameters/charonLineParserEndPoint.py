...
class charonLineParserEndPoint:
    "EndPoint parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "EndPoint"
        self.parsingKey = "end point"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "end point = {xloc} {yloc} {zloc} "
        self.interpreterQuickHelp = "set the end location of the particle strike"
        self.interpreterLongHelp = "set the end location of the particle strike <> x  y and z are in microns"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,End Point X,double,{xloc}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,End Point Y,double,{yloc}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,End Point Z,double,{zloc}")
