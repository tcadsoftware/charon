...
class charonLineParserchargeGenerationRate:
    "chargeGenerationRate parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "chargeGenerationRate"
        self.parsingKey = "charge generation rate"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "charge generation rate = {rate} "
        self.interpreterQuickHelp = "set the charge generation rate in 1/cm^3"
        self.interpreterLongHelp = "set the charge generation rate in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Generation Rate,double,{rate}")
        ...
        self.xmlRequiredArgument.append("{rate}")
