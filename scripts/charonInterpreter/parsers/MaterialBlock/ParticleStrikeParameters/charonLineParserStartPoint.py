...
class charonLineParserStartPoint:
    "StartPoint parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "StartPoint"
        self.parsingKey = "start point"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "start point = {xloc} {yloc} {zloc} "
        self.interpreterQuickHelp = "set the start location of the particle strike"
        self.interpreterLongHelp = "set the start location of the particle strike <> x  y and z are in microns"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Start Point X,double,{xloc}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Start Point Y,double,{yloc}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Particle Strike,Start Point Z,double,{zloc}")
        ...
        self.xmlRequiredArgument.append("{xloc}")
        self.xmlRequiredArgument.append("{yloc}")
        self.xmlRequiredArgument.append("{zloc}")
