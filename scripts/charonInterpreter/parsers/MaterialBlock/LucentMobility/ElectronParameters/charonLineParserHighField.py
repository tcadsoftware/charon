...
class charonLineParserHighField:
    "HighField parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HighField"
        self.parsingKey = "enable high field mobility"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "enable high field mobility "
        self.interpreterQuickHelp = "Enable the high field model"
        self.interpreterLongHelp = "Enable the high field model"
