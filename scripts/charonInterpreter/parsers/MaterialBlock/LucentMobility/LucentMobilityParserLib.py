...
import sys
from .charonBlockParserElectronParameters import *
from .charonBlockParserHoleParameters import *
from .ElectronParameters.ElectronParametersParserLib import *
from .HoleParameters.HoleParametersParserLib import *



class LucentMobilityParserLib:
    "This is the  LucentMobilityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "LucentMobilityParserLib"
        # create the linparser objects 
        self.lineParsers = []
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserElectronParameters(),ElectronParametersParserLib()])
        self.blockParsers.append([charonBlockParserHoleParameters(),HoleParametersParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(ElectronParametersParserLib())
        parserLibraries.append(HoleParametersParserLib())
