...
class charonBlockParserHoleParameters:
    "HoleParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start hole parameters"
        self.parserBlockName = "HoleParameters"
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Hole Mobility,Value,string,Lucent")
