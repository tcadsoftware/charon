...
class charonBlockParserElectronParameters:
    "ElectronParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start electron parameters"
        self.parserBlockName = "ElectronParameters"
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Value,string,Lucent")
