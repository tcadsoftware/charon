...
class charonLineParserCs:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "cs = {csval} "
        self.interpreterQuickHelp = "Masetti model parameter C_s"
        self.interpreterLongHelp = "Masetti model parameter C_s"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,cs,double,{csval}")
        ...
        self.xmlRequiredArgument.append("{csval}")
