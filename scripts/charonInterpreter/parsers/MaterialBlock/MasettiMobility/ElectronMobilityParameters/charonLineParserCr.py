...
class charonLineParserCr:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "cr = {crval} "
        self.interpreterQuickHelp = "Masetti model parameter Cr"
        self.interpreterLongHelp = "Masetti model parameter Cr"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,cr,double,{crval}")
        ...
        self.xmlRequiredArgument.append("{crval}")
