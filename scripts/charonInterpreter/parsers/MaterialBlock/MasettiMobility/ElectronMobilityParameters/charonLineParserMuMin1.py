...
class charonLineParserMuMin1:
    "MuMin1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MuMin1"
        self.parsingKey = "mumin1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "mumin1 = {mumin1val} "
        self.interpreterQuickHelp = "Masetti model parameter MuMin1"
        self.interpreterLongHelp = "Masetti model parameter MuMin1"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,mumin1,double,{mumin1val}")
        ...
        self.xmlRequiredArgument.append("{mumin1val}")
