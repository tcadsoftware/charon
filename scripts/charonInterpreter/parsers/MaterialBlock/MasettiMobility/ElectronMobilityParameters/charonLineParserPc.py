...
class charonLineParserPc:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "pc = {pcval} "
        self.interpreterQuickHelp = "Masetti model parameter p_c"
        self.interpreterLongHelp = "Masetti model parameter p_c"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,pc,double,{pcval}")
        ...
        self.xmlRequiredArgument.append("{pcval}")
