...
class charonLineParserMuMin2:
    "MuMin2 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MuMin2"
        self.parsingKey = "mumin2"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "mumin2 = {mumin2val} "
        self.interpreterQuickHelp = "Masetti model parameter MuMin2"
        self.interpreterLongHelp = "Masetti model parameter MuMin2"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,mumin2,double,{mumin2val}")
        ...
        self.xmlRequiredArgument.append("{mumin2val}")
