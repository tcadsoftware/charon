...
class charonLineParserGamma:
    "Gamma parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Gamma"
        self.parsingKey = "temperature dependence exponent"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "temperature dependence exponent = {gamma} "
        self.interpreterQuickHelp = "Exponent used for temperature dependence"
        self.interpreterLongHelp = "Exponent used for temperature dependence of lattice scattering for electrons"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,gamma,double,{gamma}")
        ...
        self.xmlRequiredArgument.append("{gamma}")
