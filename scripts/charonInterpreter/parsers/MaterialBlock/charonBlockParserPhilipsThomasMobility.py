...
class charonBlockParserPhilipsThomasMobility:
    "PhilipsThomasMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start philips-thomas mobility"
        self.parserBlockName = "PhilipsThomasMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Philips-Thomas Mobility "
