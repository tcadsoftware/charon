...
class charonLineParserVsatTempCoeff:
    "VsatTempCoeff parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "VsatTempCoeff"
        self.parsingKey = "vsat temperature coefficient"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "vsat temperature coefficient = {vsatcoeffval} "
        self.interpreterQuickHelp = "Specify the vsat temperature coefficient"
        self.interpreterLongHelp = "Specify the vsat temperature coefficient"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Vsat Temperature Coefficient,double,{vsatcoeffval}")
        ...
        self.xmlRequiredArgument.append("{vsatcoeffval}")
