...
class charonLineParserSaturationField:
    "SaturationField parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SaturationField"
        self.parsingKey = "saturation field"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "saturation field = {satval} "
        self.interpreterQuickHelp = "Specify the saturation field"
        self.interpreterLongHelp = "Specify the saturation field"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Saturation Field,double,{satval}")
