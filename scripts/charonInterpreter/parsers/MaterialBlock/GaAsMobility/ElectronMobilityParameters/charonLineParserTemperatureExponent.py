...
class charonLineParserTemperatureExponent:
    "TemperatureExponent parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TemperatureExponent"
        self.parsingKey = "temperature exponent"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "temperature exponent = {texpval} "
        self.interpreterQuickHelp = "Specify the temperature exponent"
        self.interpreterLongHelp = "Specify the temperature exponent"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Temperature Exponent,double,{texpval}")
        ...
        self.xmlRequiredArgument.append("{texpval}")
