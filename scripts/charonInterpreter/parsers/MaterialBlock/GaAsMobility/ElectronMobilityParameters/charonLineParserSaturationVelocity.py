...
class charonLineParserSaturationVelocity:
    "SaturationVelocity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SaturationVelocity"
        self.parsingKey = "saturation velocity"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "saturation velocity = {satval} "
        self.interpreterQuickHelp = "Specify the saturation velocity"
        self.interpreterLongHelp = "Specify the saturation velocity"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Saturation Velocity,double,{satval}")
        ...
        self.xmlRequiredArgument.append("{satval}")
