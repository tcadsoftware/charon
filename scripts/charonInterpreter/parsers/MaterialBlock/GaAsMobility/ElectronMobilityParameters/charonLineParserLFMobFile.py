...
class charonLineParserLFMobFile:
    "LFMobFile parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LFMobFile"
        self.parsingKey = "low field mobility file"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "low field mobility file is {lfmobvar} "
        self.interpreterQuickHelp = "Name of the tabular file containing low-field values of the mobility"
        self.interpreterLongHelp = "Name of the tabular file containing low-field values of the mobility <> The first column of the file contains a doping values and the second mobility"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Low Field Mobility File,string,{lfmobvar}")
        ...
        self.xmlRequiredArgument.append("{lfmobvar}")
