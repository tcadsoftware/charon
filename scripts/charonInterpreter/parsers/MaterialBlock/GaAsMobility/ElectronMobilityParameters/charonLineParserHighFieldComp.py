...
class charonLineParserHighFieldComp:
    "HighFieldComp parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HighFieldComp"
        ...
        self.interpreterQuickHelp = "Enable or disable the high-field component of the mobility model"
        self.interpreterLongHelp = "Enable or disable the high-field component of the mobility model"
