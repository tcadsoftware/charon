...
class charonLineParserDrivingForce:
    ...
    def __init__(self):
        ...
        self.parsingKey = "driving force for high field mobility"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("electric field")
        self.parsingKeyOptional.append("gradient quasi fermi")
        self.interpreterHelpLine = "driving force for high field mobility is [ electric field [ gradient quasi fermi ]] "
        self.interpreterQuickHelp = "Use this as the driving force for high-field mobility"
        self.interpreterLongHelp = "Use this as the driving force for high-field mobility"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Driving Force,string,ElectricField")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Driving Force,string,GradQuasiFermi")
