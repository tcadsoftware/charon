...
class charonLineParserDrivingForce:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,Driving Force,string,ElectricField")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,Driving Force,string,GradQuasiFermi")
