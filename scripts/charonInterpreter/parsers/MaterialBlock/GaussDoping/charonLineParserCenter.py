...
class charonLineParserCenter:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "peak location = {peak} [ in x [ in y [ in z]]] "
        self.interpreterQuickHelp = "Set the location where the peak of the doping is for the given coordinate direction."
        self.interpreterLongHelp = "Set the location where the peak of the doping is for the given coordinate direction."
        ...
        self.xmlRequiredArgument.append("{peak}")
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},X Peak Location,double,{peak}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Y Peak Location,double,{peak}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Z Peak Location,double,{peak}")
