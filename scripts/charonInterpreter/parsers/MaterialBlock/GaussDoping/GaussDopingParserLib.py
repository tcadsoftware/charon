...
import sys
from .charonLineParserCenter import *
...
class GaussDopingParserLib:
    "This is the  GaussDopingParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "GaussDopingParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserCenter())
