...
class charonLineParserDopingConcentrationRange:
    "DopingConcentrationRange parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DopingConcentrationRange"
        self.parsingKey = "concentration range"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Concentration range is {minimumConcentration} to {maximumConcentration} "
        self.interpreterQuickHelp = "set the range of the magnitude of the dopant concentration"
        self.interpreterLongHelp = "set the range of the magnitude of the dopant concentration <> minimumConcentration is the minimum numerical value in 1/cm^3 <> maximumConcentration is the maximum numerical value in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Doping Min Value,double,{minimumConcentration}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Doping Max Value,double,{maximumConcentration}")
        ...
        self.xmlRequiredArgument.append("{minimumConcentration}")
        self.xmlRequiredArgument.append("{maximumConcentration}")
