...
class charonLineParserAugerWithGeneration:
    "AugerWithGeneration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AugerWithGeneration"
        self.parsingKey = "generation"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Generation [ is on [is off]] "
        self.interpreterQuickHelp = "Add generation to the Auger recombination source term"
        self.interpreterLongHelp = "Add generation to the Auger recombination source term"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Auger Recombination,With Generation,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Auger Recombination,With Generation,bool,false")
