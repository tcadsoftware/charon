...
import sys
from .charonLineParserAugerWithGeneration import *
from .charonLineParserCarrierAugerCoefficient import *



class AugerRecombinationParametersParserLib:
    "This is the  AugerRecombinationParametersParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "AugerRecombinationParametersParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserAugerWithGeneration())
        self.lineParsers.append(charonLineParserCarrierAugerCoefficient())
