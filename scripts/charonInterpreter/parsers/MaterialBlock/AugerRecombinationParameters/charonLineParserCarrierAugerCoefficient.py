...
class charonLineParserCarrierAugerCoefficient:
    "CarrierAugerCoefficient parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CarrierAugerCoefficient"
        self.parsingKey = "auger coefficient"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("for electron")
        self.parsingKeyOptional.append("for hole")
        self.interpreterHelpLine = "Auger Coefficient [ for electron = {augerCoefficient} [ for hole = {augerCoefficient}]] "
        self.interpreterQuickHelp = "Set the Auger recombination coefficient value"
        self.interpreterLongHelp = "Set the Auger recombination coefficient value <> {augerCoefficient} is the coefficient."
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Auger Recombination,Electron Auger Coefficient,double,{augerCoefficient}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Auger Recombination,Hole Auger Coefficient,double,{augerCoefficient}")
        ...
        self.xmlOptionalArgument = [['{augerCoefficient}'], ['{augerCoefficient}']]
        self.xmlOptionalArgumentIndexes = [[3], [3]]
