...
class charonBlockParserMasettiMobility:
    "MasettiMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start masetti mobility"
        self.parserBlockName = "MasettiMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Masetti Mobility "
