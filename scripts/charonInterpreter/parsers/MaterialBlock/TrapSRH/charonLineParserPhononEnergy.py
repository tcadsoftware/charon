...
class charonLineParserPhononEnergy:
    "PhononEnergy parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PhononEnergy"
        self.parsingKey = "phonon energy"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "phonon energy = {value} "
        self.interpreterQuickHelp = "Phonon Energy"
        self.interpreterLongHelp = "Phonon Energy"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Phonon Energy,double,{value}")
