...
class charonLineParserTunnelingModel:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,None")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,Schenk HighTemp")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,Schenk LowTemp")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[3].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,Schenk AsymConstFDOS")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[4].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,Schenk ConstFDOS")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[5].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Model,string,Schenk NewDOS")
