...
class charonLineParserDirection:
    ...
    def __init__(self):
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Direction,string,X")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Direction,string,Y")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Hole Tunneling Direction,string,Z")
