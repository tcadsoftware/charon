...
class charonBlockParserHoleTunnelingParams:
    "HoleTunnelingParams parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start hole tunneling parameters"
        self.parserBlockName = "HoleTunnelingParams"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start hole tunneling parameters "
