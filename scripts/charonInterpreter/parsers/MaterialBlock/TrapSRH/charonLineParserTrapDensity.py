...
class charonLineParserTrapDensity:
    ...
    def __init__(self):
        ...
        self.parsingKey = "trap density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "trap density = {value} "
        self.interpreterQuickHelp = "The density of this trap"
        self.interpreterLongHelp = "The density of this trap"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Trap Density,double,{value}")
