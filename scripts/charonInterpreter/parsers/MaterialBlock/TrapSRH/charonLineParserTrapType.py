...
class charonLineParserTrapType:
    "TrapType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TrapType"
        self.parsingKey = "trap type"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("donor")
        self.parsingKeyOptional.append("acceptor")
        self.interpreterHelpLine = "trap type is [ donor [ acceptor ]] "
        self.interpreterQuickHelp = "The type of this trap."
        self.interpreterLongHelp = "The type of this trap"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Trap Type,string,Donor")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Trap Type,string,Acceptor")
