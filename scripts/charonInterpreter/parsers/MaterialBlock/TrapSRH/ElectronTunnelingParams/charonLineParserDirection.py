...
class charonLineParserDirection:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Direction of tunneling"
        self.interpreterLongHelp = "Direction of tunneling"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Direction,string,X")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Direction,string,Y")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Direction,string,Z")
