...
class charonLineParserLocation:
    "Location parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Location"
        self.parsingKey = "heterojunction location"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "heterojunction location = {value} "
        self.interpreterQuickHelp = "Spatial location of the heterojunction"
        self.interpreterLongHelp = "Spatial location of the heterojunction"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron HJ Location,double,{value}")
