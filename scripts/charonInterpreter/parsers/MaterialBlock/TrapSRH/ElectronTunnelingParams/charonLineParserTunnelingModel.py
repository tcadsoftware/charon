...
class charonLineParserTunnelingModel:
    "TunnelingModel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TunnelingModel"
        self.parsingKey = "model"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("none")
        self.parsingKeyOptional.append("high temperature")
        self.parsingKeyOptional.append("low temperature")
        self.parsingKeyOptional.append("asymmetric")
        self.parsingKeyOptional.append("constant")
        self.parsingKeyOptional.append("new")
        self.interpreterHelpLine = "model is [ none [ high temperature [ low temperature [ asymmetric [ constant [ new ]]]]]] "
        self.interpreterQuickHelp = "The tunneling model to use for holes."
        self.interpreterLongHelp = "The tunneling model to use for holes."
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,None")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,Schenk HighTemp")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,Schenk LowTemp")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[3].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,Schenk AsymConstFDOS")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[4].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,Schenk ConstFDOS")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[5].append(" Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Electron Tunneling Model,string,Schenk NewDOS")
