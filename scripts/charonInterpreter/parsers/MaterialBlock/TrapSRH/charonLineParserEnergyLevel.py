...
class charonLineParserEnergyLevel:
    ...
    def __init__(self):
        ...
        self.parsingKey = "energy level"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "energy level = {energyLev} "
        self.interpreterQuickHelp = "The energy level for this trap"
        self.interpreterLongHelp = "The energy level for this trap"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Trap SRH Recombination->{trapName},Energy Level,double,{energyLev}")
        ...
        self.xmlRequiredArgument.append("{energyLev}")
