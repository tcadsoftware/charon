...
class charonBlockParserElectronTunnelingParams:
    "ElectronTunnelingParams parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start electron tunneling parameters"
        self.parserBlockName = "ElectronTunnelingParams"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start electron tunneling parameters "
