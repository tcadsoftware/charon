...
class charonLineParserReferenceMaterial:
    "ReferenceMaterial parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ReferenceMaterial"
        self.parsingKey = "reference material"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Reference Material is {material} "
        self.interpreterQuickHelp = "Set the Reference Material. "
        self.interpreterLongHelp = " Set the Reference Material. <> Options: Silicon. "

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models,Reference Material,string,{material}")
        ...
        self.xmlRequiredArgument.append("{material}")
