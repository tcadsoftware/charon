...
class charonLineParserDopingType:
    "DopingType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DopingType"
        self.parsingKey = "type"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("donor")
        self.parsingKeyOptional.append("acceptor")
        self.interpreterHelpLine = "Type is [donor [ acceptor]] "
        self.interpreterQuickHelp = "set the dopant type to acceptor or donor"
        self.interpreterLongHelp = "set the dopant type to acceptor or donor"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Doping Type,string,Donor")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Doping Type,string,Acceptor")
