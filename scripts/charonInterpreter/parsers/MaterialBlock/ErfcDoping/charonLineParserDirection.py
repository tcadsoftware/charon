...
class charonLineParserDirection:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Where the erfc() is maximum."
        self.interpreterLongHelp = "Is the erfc() maximum value at the minimum coordinate (negative) or at the maximum coordinate (positive)."
