...
class charonLineParserCenter:
    "Center parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Center"
        self.parsingKey = "gradient center"
        ...
        self.interpreterHelpLine = "gradient center = {cent} [ in x [ in y [ in z]]] "
        self.interpreterQuickHelp = "Set the location where the doping ramps from the minimum to maximum values in x  y or z"
        self.interpreterLongHelp = "Set the location where the doping ramps from the minimum to maximum values in x  y or z"
        ...
        self.xmlRequiredArgument.append("{cent}")
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},X Bend Location,double,{cent}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Y Bend Location,double,{cent}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Z Bend Location,double,{cent}")
