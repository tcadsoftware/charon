...
class charonLineParserMoleFractionRange:
    "MoleFractionRange parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MoleFractionRange"
        ...
        self.interpreterQuickHelp = "Set the coordinate range of the uniform doping in x  y or z"
        self.interpreterLongHelp = "Set the coordinate range of the uniform doping in x  y or z"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Xmin,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Xmax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Ymin,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Ymax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Zmin,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Zmax,double,{locMax}")
