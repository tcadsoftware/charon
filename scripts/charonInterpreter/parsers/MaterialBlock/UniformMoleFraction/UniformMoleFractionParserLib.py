...
import sys
from .charonLineParserMoleFractionRange import *
from .charonLineParserMoleFracValue import *



class UniformMoleFractionParserLib:
    "This is the  UniformMoleFractionParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "UniformMoleFractionParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserMoleFractionRange())
        self.lineParsers.append(charonLineParserMoleFracValue())
