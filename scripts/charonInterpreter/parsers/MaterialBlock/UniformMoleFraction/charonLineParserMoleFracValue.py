...
class charonLineParserMoleFracValue:
    "MoleFracValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MoleFracValue"
        self.parsingKey = "mole value"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "mole value = {mval} "
        self.interpreterQuickHelp = "set the mole fraction value for the material"
        self.interpreterLongHelp = "set the mole fraction value for the material"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Mole Value,double,{mval}")
        ...
        self.xmlRequiredArgument.append("{mval}")
