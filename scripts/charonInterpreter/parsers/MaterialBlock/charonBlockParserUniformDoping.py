...
class charonBlockParserUniformDoping:
    "UniformDoping parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start uniform doping named"
        self.parserBlockName = "UniformDoping"
        ...
        self.interpreterBlockHelpLine = "start uniform doping named {functionName} "
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Function Type,string,Uniform")
