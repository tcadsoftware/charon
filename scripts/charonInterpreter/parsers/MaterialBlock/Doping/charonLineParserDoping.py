...
class charonLineParserDoping:
    "Doping parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Doping"
        self.parsingKey = "doping"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Doping for {accdon} is {value} "
        self.interpreterQuickHelp = "Set the doping value "
        self.interpreterLongHelp = "Set the doping value <> accdon is the carrier <> value is the value "

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->{accdon} Doping,Value,double,{value}")
        ...
        self.xmlRequiredArgument.append("{accdon}")
