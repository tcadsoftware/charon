...
import sys
from .charonLineParserDoping import *



class DopingParserLib:
    "This is the  DopingParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "DopingParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserDoping())
