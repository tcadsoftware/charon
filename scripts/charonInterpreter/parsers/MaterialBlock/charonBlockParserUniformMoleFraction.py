...
class charonBlockParserUniformMoleFraction:
    "UniformMoleFraction parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start uniform mole fraction"
        self.parserBlockName = "UniformMoleFraction"
        ...
        self.interpreterBlockHelpLine = "start uniform mole fraction {functionName} "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Mole Fraction,Value,string,Function")
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Mole Fraction->{functionName},Function Type,string,Uniform")
