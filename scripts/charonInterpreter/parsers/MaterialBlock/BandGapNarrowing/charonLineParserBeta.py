...
class charonLineParserBeta:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the band gap beta value"
        self.interpreterLongHelp = "Set the band gap beta value."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,beta,double,{beta}")
