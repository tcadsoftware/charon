...
class charonLineParserTemperatureDependence:
    "TemperatureDependence parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TemperatureDependence"
        self.parsingKey = "temperature dependence is on"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "temperature dependence is on "
        self.interpreterQuickHelp = "Set the band gap naorrowing model to be temperature dependent"
        self.interpreterLongHelp = "Set the band gap naorrowing model to be temperature dependent "

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,Value,string,TempDep")
