...
class charonLineParserChi300:
    "Chi300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Chi300"
        self.parsingKey = "chi300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Chi300 = {chi} "
        self.interpreterQuickHelp = "Set the 300 k chi value"
        self.interpreterLongHelp = "Set the 300 k chi value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,Chi300,double,{chi}")
        ...
        self.xmlRequiredArgument.append("{chi}")
