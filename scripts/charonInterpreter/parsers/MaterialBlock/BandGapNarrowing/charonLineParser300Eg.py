...
class charonLineParser300Eg:
    "300Eg parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "300Eg"
        self.parsingKey = "300k gap"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "300k gap = {bandgap} "
        self.interpreterQuickHelp = "Set the band gap 300 k value"
        self.interpreterLongHelp = "Set the band gap 300 k value <> badgap is the gap in eV."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,Eg300,double,{bandgap}")
        ...
        self.xmlRequiredArgument.append("{bandgap}")
