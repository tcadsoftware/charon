...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the band gap model alpha value"
        self.interpreterLongHelp = "Set the band gap model alpha value."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Band Gap,alpha,double,{alpha}")
