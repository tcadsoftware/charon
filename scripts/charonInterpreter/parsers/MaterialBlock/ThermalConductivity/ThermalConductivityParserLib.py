...
from .charonLineParserKappa300 import *
from .charonLineParserAlpha import *



class ThermalConductivityParserLib:
    "This is the  ThermalConductivityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "ThermalConductivityParserLib"
        ...
        self.lineParsers.append(charonLineParserKappa300())
