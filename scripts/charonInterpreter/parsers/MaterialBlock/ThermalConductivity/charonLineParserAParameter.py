...
class charonLineParserAParameter:
    "AParameter parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AParameter"
        self.parsingKey = "a"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "a = {aval} "
        self.interpreterQuickHelp = "Set the parameter a for thermal conductivity TempDep model"
        self.interpreterLongHelp = "Set the parameter a for thermal conductivity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Thermal Conductivity,a,double,{aval}")
        ...
        self.xmlRequiredArgument.append("{aval}")
