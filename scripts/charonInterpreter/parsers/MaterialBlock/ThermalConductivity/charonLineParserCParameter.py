...
class charonLineParserCParameter:
    "CParameter parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CParameter"
        self.parsingKey = "c"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "c = {cval} "
        self.interpreterQuickHelp = "Set the parameter c for thermal conductivity TempDep model"
        self.interpreterLongHelp = "Set the parameter c for thermal conductivity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Thermal Conductivity,c,double,{cval}")
        ...
        self.xmlRequiredArgument.append("{cval}")
