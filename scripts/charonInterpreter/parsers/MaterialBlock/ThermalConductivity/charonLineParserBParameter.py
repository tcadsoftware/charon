...
class charonLineParserBParameter:
    "BParameter parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BParameter"
        self.parsingKey = "b"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "b = {bval} "
        self.interpreterQuickHelp = "Set the parameter b for thermal conductivity TempDep model"
        self.interpreterLongHelp = "Set the parameter b for thermal conductivity TempDep model"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Thermal Conductivity,b,double,{bval}")
        ...
        self.xmlRequiredArgument.append("{bval}")
