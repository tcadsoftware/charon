...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Set the alpha value"
        self.interpreterLongHelp = "Set the alpha value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Thermal Conductivity,alpha,double,{alphaval}")
