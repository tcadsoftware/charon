...
class charonLineParserKappa300:
    "Kappa300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Kappa300"
        self.parsingKey = "kappa300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "kappa300 = {kappa} "
        self.interpreterQuickHelp = "Set the 300K kappa value"
        self.interpreterLongHelp = "Set the 300K kappa value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Thermal Conductivity,kappa300,double,{kappa}")
        ...
        self.xmlRequiredArgument.append("{kappa}")
