...
class charonBlockParserCarrierLifetime:
    "CarrierLifetime parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start carrier lifetime"
        self.parserBlockName = "CarrierLifetime"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Carrier Lifetime block "
