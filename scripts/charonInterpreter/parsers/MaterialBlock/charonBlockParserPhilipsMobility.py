...
class charonBlockParserPhilipsMobility:
    "PhilipsMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start philips mobility"
        self.parserBlockName = "PhilipsMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Philips Mobility "
