...
class charonBlockParserAlbrechtMobility:
    "AlbrechtMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start albrecht mobility"
        self.parserBlockName = "AlbrechtMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Albrecht Mobility "
