...
class charonLineParserDelta:
    "Delta parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Delta"
        self.parsingKey = "delta"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "delta = {deltaval} "
        self.interpreterQuickHelp = "Farahmand model parameter delta"
        self.interpreterLongHelp = "Farahmand model parameter delta"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,delta,double,{deltaval}")
        ...
        self.xmlRequiredArgument.append("{deltaval}")
