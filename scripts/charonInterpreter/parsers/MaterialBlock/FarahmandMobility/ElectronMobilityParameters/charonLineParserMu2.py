...
class charonLineParserMu2:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "mu2 = {mu2val} "
        self.interpreterQuickHelp = "Farahmand model parameter mu_2"
        self.interpreterLongHelp = "Farahmand model parameter mu_2"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,mu2,double,{mu2val}")
        ...
        self.xmlRequiredArgument.append("{mu2val}")
