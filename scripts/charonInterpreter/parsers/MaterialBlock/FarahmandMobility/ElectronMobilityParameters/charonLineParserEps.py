...
class charonLineParserEps:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "eps = {epsval} "
        self.interpreterQuickHelp = "Farahmand model parameter eps"
        self.interpreterLongHelp = "Farahmand model parameter eps"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,eps,double,{epsval}")
        ...
        self.xmlRequiredArgument.append("{epsval}")
