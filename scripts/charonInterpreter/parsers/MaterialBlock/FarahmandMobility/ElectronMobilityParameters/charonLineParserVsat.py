...
class charonLineParserVsat:
    "Vsat parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Vsat"
        self.parsingKey = "vsat"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "vsat = {vsatval} "
        self.interpreterQuickHelp = "Farahmand model parameter vsat"
        self.interpreterLongHelp = "Farahmand model parameter vsat"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,vsat,double,{vsat}")
        ...
        self.xmlRequiredArgument.append("{vsatval}")
