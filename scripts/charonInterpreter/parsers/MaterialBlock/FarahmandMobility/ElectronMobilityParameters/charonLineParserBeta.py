...
class charonLineParserBeta:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Farahmand model parameter beta"
        self.interpreterLongHelp = "Farahmand model parameter beta"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,beta,double,{betaval}")
