...
class charonLineParserAlpha:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Farahmand model parameter alpha"
        self.interpreterLongHelp = "Farahmand model parameter alpha"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,alpha,double,{alphaval}")
