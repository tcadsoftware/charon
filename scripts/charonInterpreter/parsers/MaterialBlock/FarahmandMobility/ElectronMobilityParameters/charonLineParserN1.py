...
class charonLineParserN1:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "n1 = {n1val} "
        self.interpreterQuickHelp = "Farahmand model parameter n1"
        self.interpreterLongHelp = "Farahmand model parameter n1"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,n1,double,{n1val}")
        ...
        self.xmlRequiredArgument.append("{n1val}")
