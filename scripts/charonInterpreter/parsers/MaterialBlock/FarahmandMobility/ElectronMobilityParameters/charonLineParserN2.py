...
class charonLineParserN2:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "n2 = {n2val} "
        self.interpreterQuickHelp = "Farahmand model parameter n2"
        self.interpreterLongHelp = "Farahmand model parameter n2"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,n2,double,{n2val}")
        ...
        self.xmlRequiredArgument.append("{n2val}")
