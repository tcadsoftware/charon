...
class charonLineParserAn:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "an = {anval} "
        self.interpreterQuickHelp = "Farahmand model parameter an"
        self.interpreterLongHelp = "Farahmand model parameter an"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,an,double,{an}")
        ...
        self.xmlRequiredArgument.append("{anval}")
