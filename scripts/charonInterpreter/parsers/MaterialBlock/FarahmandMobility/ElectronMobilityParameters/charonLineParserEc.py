...
class charonLineParserEc:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "ec = {ecval} "
        self.interpreterQuickHelp = "Farahmand model parameter ec"
        self.interpreterLongHelp = "Farahmand model parameter ec"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,ec,double,{ec}")
        ...
        self.xmlRequiredArgument.append("{ecval}")
