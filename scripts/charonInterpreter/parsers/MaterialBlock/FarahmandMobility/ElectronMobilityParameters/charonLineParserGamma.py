...
class charonLineParserGamma:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "gamma = {gammaval} "
        self.interpreterQuickHelp = "Farahmand model parameter gamma"
        self.interpreterLongHelp = "Farahmand model parameter gamma"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,gamma,double,{gammaval}")
        ...
        self.xmlRequiredArgument.append("{gammaval}")
