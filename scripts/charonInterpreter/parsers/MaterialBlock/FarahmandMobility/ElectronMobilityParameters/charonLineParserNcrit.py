...
class charonLineParserNcrit:
    "Ncrit parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Ncrit"
        self.parsingKey = "ncrit"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "ncrit = {ncritval} "
        self.interpreterQuickHelp = "Farahmand model parameter ncrit"
        self.interpreterLongHelp = "Farahmand model parameter ncrit"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,ncrit,double,{ncritval}")
        ...
        self.xmlRequiredArgument.append("{ncritval}")
