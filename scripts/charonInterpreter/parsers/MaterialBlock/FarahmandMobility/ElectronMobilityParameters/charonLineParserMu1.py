...
class charonLineParserMu1:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "mu1 = {mu1val} "
        self.interpreterQuickHelp = "Farahmand model parameter mu_1"
        self.interpreterLongHelp = "Farahmand model parameter mu_1"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,mu1,double,{mu1val}")
        ...
        self.xmlRequiredArgument.append("{mu1val}")
