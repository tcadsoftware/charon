...
class charonBlockParserThermalConductivity:
    "ThermalConductivity parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start thermal conductivity"
        self.parserBlockName = "ThermalConductivity"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start thermal conductivity "
