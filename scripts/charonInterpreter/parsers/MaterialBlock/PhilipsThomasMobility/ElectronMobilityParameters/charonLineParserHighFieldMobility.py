...
class charonLineParserHighFieldMobility:
    "HighFieldMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "HighFieldMobility"
        self.parsingKey = "high field component"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "high field component [is on [is off]] "
        self.interpreterQuickHelp = "Enable or disable the field component of the mobility model for electrons"
        self.interpreterLongHelp = "Enable or disable the field component of the mobility model for electrons"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,High Field,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,High Field,string,Off")
