...
class charonLineParserMinimumMobility:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "minimum mobility = {minMobility} "
        self.interpreterQuickHelp = "Sets the minimum value for mobility in this mobility model"
        self.interpreterLongHelp = "Sets the minimum value for mobility in this mobility model <> minMobilty is the minimum numerical value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,mumin,double,{minMobility}")
        ...
        self.xmlRequiredArgument.append("{minMobility}")
