...
class charonLineParserDrivingForce:
    ...
    def __init__(self):
        ...
        self.parsingKeyOptional.append("grad quasifermi")
        self.interpreterHelpLine = "Driving force is [ electric field [ grad quasiFermi]] "
        self.interpreterQuickHelp = "Set the driving force in the mobility model"
        self.interpreterLongHelp = "Set the driving force in the mobility model <> options are electric field or grad quasifermi"
