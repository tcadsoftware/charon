...
class charonLineParserNREF:
    "NREF parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NREF"
        self.parsingKey = "reference impurity concentration"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "reference impurity concentration = {nref} "
        self.interpreterQuickHelp = "Reference impurity concentration"
        self.interpreterLongHelp = "Reference impurity concentration"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,nref,double,{nref}")
        ...
        self.xmlRequiredArgument.append("{nref}")
