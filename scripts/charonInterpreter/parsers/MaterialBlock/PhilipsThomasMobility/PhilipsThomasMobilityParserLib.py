...
import sys
from .charonBlockParserHoleMobilityParameters import *
from .charonBlockParserElectronMobilityParameters import *
from .HoleMobilityParameters.HoleMobilityParametersParserLib import *
from .ElectronMobilityParameters.ElectronMobilityParametersParserLib import *



class PhilipsThomasMobilityParserLib:
    "This is the  PhilipsThomasMobilityParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "PhilipsThomasMobilityParserLib"
        # create the linparser objects 
        self.lineParsers = []
        # create the blockparser objects 
        self.blockParsers = []
        self.blockParsers.append([charonBlockParserHoleMobilityParameters(),HoleMobilityParametersParserLib()])
        self.blockParsers.append([charonBlockParserElectronMobilityParameters(),ElectronMobilityParametersParserLib()])
        # create the parserLibrary objects 
        parserLibraries = []
        parserLibraries.append(HoleMobilityParametersParserLib())
        parserLibraries.append(ElectronMobilityParametersParserLib())
