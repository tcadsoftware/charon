...
class charonLineParserHighFieldMobility:
    ...
    def __init__(self):
        ...
        self.interpreterQuickHelp = "Enable or disable the field component of the mobility model for holes"
        self.interpreterLongHelp = "Enable or disable the field component of the mobility model for holes"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,High Field,string,On")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,High Field,string,Off")
