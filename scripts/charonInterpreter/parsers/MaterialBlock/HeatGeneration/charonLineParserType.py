...
class charonLineParserType:
    ...
    def __init__(self):
        ...
        self.parsingKeyOptional.append("linear")
        self.interpreterHelpLine = "type is [constant [linear]] "
        self.interpreterQuickHelp = "Set type"
        self.interpreterLongHelp = "Set type for heat generation"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Heat Generation,Type,string,Constant")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Heat Generation,Type,string,Linear")
