...
import sys
from .charonLineParserConstantValue import *
from .charonLineParserType import *
from .charonLineParserLinearFactor import *
from .charonLineParserBehaviorModel import *



class HeatGenerationParserLib:
    "This is the  HeatGenerationParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "HeatGenerationParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserConstantValue())
        self.lineParsers.append(charonLineParserType())
        self.lineParsers.append(charonLineParserLinearFactor())
