...
class charonLineParserLinearFactor:
    "LinearFactor parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "LinearFactor"
        self.parsingKey = "linear factor"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "linear factor = {val} "
        self.interpreterQuickHelp = "Set linear factor for linear type of analytic heat generation"
        self.interpreterLongHelp = "Set linear factor for linear type of analytic heat generation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Generation,Linear Factor,double,{val}")
        ...
        self.xmlRequiredArgument.append("{val}")
