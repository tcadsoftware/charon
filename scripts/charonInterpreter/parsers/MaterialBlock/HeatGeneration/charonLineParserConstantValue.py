...
class charonLineParserConstantValue:
    "ConstantValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ConstantValue"
        self.parsingKey = "constant value"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "constant value = {cval} "
        self.interpreterQuickHelp = "Set constant value"
        self.interpreterLongHelp = "Set constant value for heat generation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Generation,Constant Value,double,{cval}")
