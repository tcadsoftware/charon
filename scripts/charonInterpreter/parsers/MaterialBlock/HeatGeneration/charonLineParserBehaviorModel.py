...
class charonLineParserBehaviorModel:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "behavior model is analytic "
        self.interpreterQuickHelp = "Set behavior model for heat generation"
        self.interpreterLongHelp = "Set behavior model for heat generation"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Heat Generation,Value,string,Analytic")
