...
class charonBlockParserLinearDoping:
    "LinearDoping parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start linear doping named"
        self.parserBlockName = "LinearDoping"
        ...
        self.interpreterBlockHelpLine = "start linear doping named {functionName} "
        ...
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Function Type,string,Linear")
