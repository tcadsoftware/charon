...
class charonBlockParserAroraMobility:
    "AroraMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start arora mobility"
        self.parserBlockName = "AroraMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start Arora Mobility "
