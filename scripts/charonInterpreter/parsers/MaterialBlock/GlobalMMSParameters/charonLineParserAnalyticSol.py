...
class charonLineParserAnalyticSol:
    "AnalyticSol parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AnalyticSol"
        self.parsingKey = "analytic solution function"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "analytic solution function is {funcname} "
        self.interpreterQuickHelp = "Name of the function computing the analytic solution"
        self.interpreterLongHelp = "Name of the function computing the analytic solution"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Analytic Solution,Value,string,{funcname}")
