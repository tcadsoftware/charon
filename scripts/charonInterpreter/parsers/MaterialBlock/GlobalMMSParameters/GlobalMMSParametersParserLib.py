...
import sys
from .charonLineParserErrorStats import *
from .charonLineParserAnalyticSol import *



class GlobalMMSParametersParserLib:
    "This is the  GlobalMMSParametersParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "GlobalMMSParametersParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserErrorStats())
        self.lineParsers.append(charonLineParserAnalyticSol())
