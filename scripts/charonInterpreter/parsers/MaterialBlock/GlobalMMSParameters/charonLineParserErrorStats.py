...
class charonLineParserErrorStats:
    "ErrorStats parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ErrorStats"
        self.parsingKey = "error statistics"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "error statistics for {varlist} "
        self.interpreterQuickHelp = "Calculate some global error statistics for the named variables"
        self.interpreterLongHelp = "Calculate some global error statistics for the named variables"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Global Statistics,Value,string,{varlist}")
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Analytic Comparison,Value,string,{varlist}")
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Analytic Comparison: Relative Error,Value,string,{varlist}")
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Analytic Comparison: Relative Error,Use Absolute,bool,true")
        self.xmlRequiredLines.append("Charon->Closure Models->Global MMS Parameters->Analytic Comparison: L2 Error,Value,string,{varlist}")
        ...
        self.xmlRequiredArgument.append("{varlist}")
