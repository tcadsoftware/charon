...
class charonLineParsernrefexp:
    "nrefexp parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "nrefexp"
        self.parsingKey = "nrefexp"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "nrefexp = {nrefexpval} "
        self.interpreterQuickHelp = "model parameter exponenetial power for N_ref"
        self.interpreterLongHelp = "Arora model parameter exponential power for N_ref"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,nrefexp,double,{nrefexpval}")
        ...
        self.xmlRequiredArgument.append("{nrefexpval}")
