...
class charonLineParserexp1:
    "exp1 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "exp1"
        self.parsingKey = "exp1"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "exp1 = {exp1val} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,exp1,double,{exp1val}")
        ...
        self.xmlRequiredArgument.append("{exp1val}")
