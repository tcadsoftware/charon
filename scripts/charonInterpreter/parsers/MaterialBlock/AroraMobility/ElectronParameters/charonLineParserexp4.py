...
class charonLineParserexp4:
    "exp4 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "exp4"
        self.parsingKey = "exp4"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "exp4 = {exp4val} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,exp4,double,{exp4val}")
        ...
        self.xmlRequiredArgument.append("{exp4val}")
