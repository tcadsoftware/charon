...
import sys
from .charonLineParserexp1 import *
from .charonLineParserexp4 import *
from .charonLineParsernref import *
from .charonLineParserexp3 import *
from .charonLineParserexp2 import *
from .charonLineParsernrefexp import *
from .charonLineParsermumax import *
from .charonLineParsermumin import *



class ElectronParametersParserLib:
    "This is the  ElectronParametersParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "ElectronParametersParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserexp1())
        self.lineParsers.append(charonLineParserexp4())
        self.lineParsers.append(charonLineParsernref())
        self.lineParsers.append(charonLineParserexp3())
        self.lineParsers.append(charonLineParserexp2())
        self.lineParsers.append(charonLineParsernrefexp())
        self.lineParsers.append(charonLineParsermumax())
        self.lineParsers.append(charonLineParsermumin())
