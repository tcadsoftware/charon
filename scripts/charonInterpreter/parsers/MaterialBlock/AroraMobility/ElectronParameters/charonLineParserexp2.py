...
class charonLineParserexp2:
    "exp2 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "exp2"
        self.parsingKey = "exp2"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "exp2 = {exp2val} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,exp2,double,{exp2val}")
        ...
        self.xmlRequiredArgument.append("{exp2val}")
