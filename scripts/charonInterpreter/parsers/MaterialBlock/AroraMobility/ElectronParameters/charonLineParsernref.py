...
class charonLineParsernref:
    ...
    def __init__(self):
        ...
        self.interpreterHelpLine = "nref = {nrefval} "
        self.interpreterQuickHelp = "model parameter N_ref"
        self.interpreterLongHelp = "Arora model parameter N_ref"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,nref,double,{nrefval}")
        ...
        self.xmlRequiredArgument.append("{nrefval}")
