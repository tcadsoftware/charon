...
class charonLineParserexp3:
    "exp3 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "exp3"
        self.parsingKey = "exp3"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "exp3 = {exp3val} "
        ...
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Electron Mobility,exp3,double,{exp3val}")
        ...
        self.xmlRequiredArgument.append("{exp3val}")
