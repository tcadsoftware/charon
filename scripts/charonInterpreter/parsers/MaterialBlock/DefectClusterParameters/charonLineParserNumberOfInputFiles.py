...
class charonLineParserNumberOfInputFiles:
    "NumberOfInputFiles parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NumberOfInputFiles"
        self.parsingKey = "number of cluster data files"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Number of cluster data files = {numberOfFiles} "
        self.interpreterQuickHelp = "set the number of tabulated cluster data files"
        self.interpreterLongHelp = "set the number of tabulated cluster data files"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Defect Cluster Recombination,Number of Input Files,int,{numberOfFiles}")
        ...
        self.xmlRequiredArgument.append("{numberOfFiles}")
