...
class charonLineParserClusterLocations:
    "ClusterLocations parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ClusterLocations"
        self.parsingKey = "cluster locations file is"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Cluster locations file is {locationsFile} "
        self.interpreterQuickHelp = "Set the file name containing the locations of the clusters."
        self.interpreterLongHelp = "Set the file name containing the locations of the clusters."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Defect Cluster Recombination,Cluster Locations File,string,{locationsFile}")
        ...
        self.xmlRequiredArgument.append("{locationsFile}")
