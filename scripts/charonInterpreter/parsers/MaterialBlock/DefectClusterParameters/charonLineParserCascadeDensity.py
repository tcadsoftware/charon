...
class charonLineParserCascadeDensity:
    "CascadeDensity parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CascadeDensity"
        self.parsingKey = "cascade density"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Cascade density = {cascadeDensity} "
        self.interpreterQuickHelp = "set the cascade density in 1/cm^3"
        self.interpreterLongHelp = "set the cascade density in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Defect Cluster Recombination,Cascade Density,double,{cascadeDensity}")
        ...
        self.xmlRequiredArgument.append("{cascadeDensity}")
