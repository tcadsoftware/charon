...
class charonLineParserVerbosityLevel:
    "VerbosityLevel parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "VerbosityLevel"
        self.parsingKey = "verbosity level"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "verbosity level = {verbosityLevel} "
        self.interpreterQuickHelp = "Set the verbosity level for the cluster simulations"
        self.interpreterLongHelp = "Set the verbosity level for the cluster simulations <> This is an integer with a higher value equals a greater verbosity"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Defect Cluster Recombination,Cluster Verbosity,int,{verbosityLevel}")
        ...
        self.xmlRequiredArgument.append("{verbosityLevel}")
