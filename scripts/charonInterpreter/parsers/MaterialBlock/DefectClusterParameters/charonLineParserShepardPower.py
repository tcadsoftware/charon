...
class charonLineParserShepardPower:
    "ShepardPower parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ShepardPower"
        self.parsingKey = "shepard power"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Shepard power = {shepardPower} "
        self.interpreterQuickHelp = "set the exponent to be used in Shepard's interpolation scheme"
        self.interpreterLongHelp = "set the exponent to be used in Shepard's interpolation scheme"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Defect Cluster Recombination,Shepard Power,double,{shepardPower}")
        ...
        self.xmlRequiredArgument.append("{shepardPower}")
