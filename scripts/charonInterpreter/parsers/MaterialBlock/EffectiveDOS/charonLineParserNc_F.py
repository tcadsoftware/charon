...
class charonLineParserNc_F:
    "Nc_F parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Nc_F"
        self.parsingKey = "nc_f"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Nc_F = {valncf} "
        self.interpreterQuickHelp = "Set the Nc_F parameter value"
        self.interpreterLongHelp = "Set the Nc_F parameter value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Effective DOS,Nc_F,double,{valncf}")
        ...
        self.xmlRequiredArgument.append("{valncf}")
