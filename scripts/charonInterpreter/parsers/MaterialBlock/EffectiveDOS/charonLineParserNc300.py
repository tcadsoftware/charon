...
class charonLineParserNc300:
    "Nc300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Nc300"
        self.parsingKey = "nc300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Nc300 = {valnc} "
        self.interpreterQuickHelp = "Set the 300K Nc value"
        self.interpreterLongHelp = "Set the 300K Nc value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Effective DOS,Nc300,double,{valnc}")
        ...
        self.xmlRequiredArgument.append("{valnc}")
