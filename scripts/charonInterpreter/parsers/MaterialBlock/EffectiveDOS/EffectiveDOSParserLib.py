...
import sys
from .charonLineParserNc_F import *
from .charonLineParserNc300 import *
from .charonLineParserNv300 import *
from .charonLineParserNv_F import *



class EffectiveDOSParserLib:
    "This is the  EffectiveDOSParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "EffectiveDOSParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserNc_F())
        self.lineParsers.append(charonLineParserNc300())
        self.lineParsers.append(charonLineParserNv300())
        self.lineParsers.append(charonLineParserNv_F())
