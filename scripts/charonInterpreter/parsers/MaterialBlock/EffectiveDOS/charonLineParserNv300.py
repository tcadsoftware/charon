...
class charonLineParserNv300:
    "Nv300 parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Nv300"
        self.parsingKey = "nv300"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Nv300 = {valnv} "
        self.interpreterQuickHelp = "Set the 300K Nv value"
        self.interpreterLongHelp = "Set the 300K Nv value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Effective DOS,Nv300,double,{valnv}")
        ...
        self.xmlRequiredArgument.append("{valnv}")
