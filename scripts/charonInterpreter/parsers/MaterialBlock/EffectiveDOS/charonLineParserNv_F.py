...
class charonLineParserNv_F:
    "Nv_F parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "Nv_F"
        self.parsingKey = "nv_f"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Nv_F = {valnvf} "
        self.interpreterQuickHelp = "Set the Nv_F parameter value"
        self.interpreterLongHelp = "Set the Nv_F parameter value"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Effective DOS,Nv_F,double,{valnvf}")
        ...
        self.xmlRequiredArgument.append("{valnvf}")
