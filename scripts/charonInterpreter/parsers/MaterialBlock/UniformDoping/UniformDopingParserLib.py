...
import sys
from .charonLineParserDopingConcentration import *
from .charonLineParserDopingType import *
from .charonLineParserDopingRange import *



class UniformDopingParserLib:
    "This is the  UniformDopingParserLib parser library "


    def __init__(self):
        # set the parser library name 
        self.parserLibName = "UniformDopingParserLib"
        # create the linparser objects 
        self.lineParsers = []
        self.lineParsers.append(charonLineParserDopingConcentration())
