...
class charonLineParserDopingConcentration:
    "DopingConcentration parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DopingConcentration"
        self.parsingKey = "concentration"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Concentration = {concentration} "
        self.interpreterQuickHelp = "set the magnitude of the dopant concentration"
        self.interpreterLongHelp = "set the magnitude of the dopant concentration <> concentration is the numerical value in 1/cm^3"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Doping Value,double,{concentration}")
