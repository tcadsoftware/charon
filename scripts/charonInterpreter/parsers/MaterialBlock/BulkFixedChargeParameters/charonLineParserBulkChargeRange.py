...
class charonLineParserBulkChargeRange:
    "BulkChargeRange parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "BulkChargeRange"
        ...
        self.interpreterQuickHelp = "Set the coordinate range of the fixed bulk charge in x  y or z"
        self.interpreterLongHelp = "Set the coordinate range of the fixed bulk charge in x  y or z"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Xmin,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Xmax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Ymin,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Ymax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Zmin,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Zmax,double,{locMax}")
