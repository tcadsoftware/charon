...
class charonLineParserChargeDistribution:
    "ChargeDistribution parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ChargeDistribution"
        self.parsingKey = "distribution is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("uniform")
        self.interpreterHelpLine = "distribution is [uniform] "
        self.interpreterQuickHelp = "Specify charge distribution function for bulk fixed charge"
        self.interpreterLongHelp = "Specify charge distribution function for bulk fixed charge <> uniform--specify extents"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Fixed Charge->Function 1,Function Type,string,Uniform")
