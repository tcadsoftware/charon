...
class charonLineParserRadiativeRecombinationCoefficient:
    "RadiativeRecombinationCoefficient parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "RadiativeRecombinationCoefficient"
        self.parsingKey = "radiative recombination coefficient"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Radiative recombination coefficient = {coefficient} "
        self.interpreterQuickHelp = "Specify coefficient for radiative recombination source term"
        self.interpreterLongHelp = "Specify coefficient for radiative recombination source term <> {coefficient} is the coefficient"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Radiative Recombination,Coefficient,double,{coefficient}")
        ...
        self.xmlRequiredArgument.append("{coefficient}")
