...
class charonBlockParserStepDoping:
    "StepDoping parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start step junction doping"
        self.parserBlockName = "StepDoping"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start step junction doping "

        # Register the xml default lines
        self.xmlDefaultLines = []
        self.xmlDefaultLines.append("Charon->Closure Models->{MaterialBlockName}->Doping,Value,string,Step Junction")
