...
class charonBlockParserMOSFETMobility:
    "MOSFETMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start mosfet mobility"
        self.parserBlockName = "MOSFETMobility"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start MOSFET Mobility "
