...
class charonLineParserAroraMobility:
    "AroraMobility parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AroraMobility"
        self.parsingKey = "arora mobility"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("electrons")
        self.parsingKeyOptional.append("holes")
        self.interpreterHelpLine = "arora mobility for [ electrons [ holes ]] "
        self.interpreterQuickHelp = "Set the mobility model for the specified carrier to Arora"
        self.interpreterLongHelp = "Set the mobility for the specified carrier to Arora "
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Electron Mobility,Value,string,Arora")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Hole Mobility,Value,string,Arora")
