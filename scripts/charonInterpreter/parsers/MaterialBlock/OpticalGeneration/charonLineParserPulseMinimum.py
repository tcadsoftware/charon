...
class charonLineParserPulseMinimum:
    "PulseMinimum parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PulseMinimum"
        self.parsingKey = "minimum pulse rate ="
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Minimum pulse rate = {pulseRate} "
        self.interpreterQuickHelp = "set the minimum hole/electron pair production rate of the pulse"
        self.interpreterLongHelp = "set the minimum hole/electron pair production rate of the pulse"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Min Value,double,{pulseRate}")
        ...
        self.xmlRequiredArgument.append("{pulseRate}")
