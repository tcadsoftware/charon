...
class charonLineParserOpticalFile:
    "OpticalFile parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OpticalFile"
        self.parsingKey = "read optical generation from"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "read optical generation from {filename} "
        self.interpreterQuickHelp = "Read the optical generation from a tabulated file"
        self.interpreterLongHelp = "Read the optical generation from a tabulated file <> {filename} is the name of the file to be read"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},File Name,string,{filename}")
