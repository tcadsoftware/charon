...
class charonLineParserOpticalRange:
    "OpticalRange parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OpticalRange"
        ...
        self.interpreterQuickHelp = "Set the coordinate range of the optical domain in x  y or z"
        self.interpreterLongHelp = "Set the coordinate range of the optical in x  y or z"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Xmin,double,{locMin}")
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Xmax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Ymin,double,{locMin}")
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Ymax,double,{locMax}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Zmin,double,{locMin}")
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Zmax,double,{locMax}")
