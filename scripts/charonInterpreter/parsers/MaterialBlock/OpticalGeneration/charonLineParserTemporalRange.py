...
class charonLineParserTemporalRange:
    "TemporalRange parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TemporalRange"
        self.parsingKey = "temporal range is"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "temporal range is {timeStart} to {timeEnd} "
        self.interpreterQuickHelp = "set the start and end time for an analytical pulse"
        self.interpreterLongHelp = "set the start and end time for an analytical pulse"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Time Min,double,{timeStart}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Time Max,double,{timeEnd}")
        ...
        self.xmlRequiredArgument.append("{timeStart}")
        self.xmlRequiredArgument.append("{timeEnd}")
