...
class charonLineParserPulseTimeWidth:
    "PulseTimeWidth parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PulseTimeWidth"
        self.parsingKey = "pulse time width ="
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Pulse time width = {timeWidth} "
        self.interpreterQuickHelp = "set the time width of the pulse"
        self.interpreterLongHelp = "set the time width of the pulse"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Time Width,double,{timeWidth}")
        self.xmlRequiredLines.append("Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Time Direction,string,Both")
        ...
        self.xmlRequiredArgument.append("{timeWidth}")
