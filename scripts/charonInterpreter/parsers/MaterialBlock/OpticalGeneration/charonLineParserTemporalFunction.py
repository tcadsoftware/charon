...
class charonLineParserTemporalFunction:
    "TemporalFunction parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "TemporalFunction"
        self.parsingKey = "temporal function is"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("gauss")
        self.interpreterHelpLine = "temporal function is [ Gauss ] "
        self.interpreterQuickHelp = "set the optical generation temporal function type"
        self.interpreterLongHelp = "set the optical generation temporal function type"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Function Type,string,Gauss")
