...
class charonLineParserOpticalType:
    "OpticalType parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "OpticalType"
        self.parsingKey = "spatial distribution"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("file")
        self.parsingKeyOptional.append("gauss")
        self.parsingKeyOptional.append("gaussian")
        self.interpreterHelpLine = "spatial distribution is [File [ Gauss [Gaussian]]] "
        self.interpreterQuickHelp = "set the optical generation type"
        self.interpreterLongHelp = "set the optical generation type"
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Function Type,string,File")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Function Type,string,Gauss")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Optical Generation->{functionName},Function Type,string,Gaussian")
