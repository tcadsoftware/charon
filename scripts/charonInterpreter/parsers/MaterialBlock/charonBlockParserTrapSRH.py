...
class charonBlockParserTrapSRH:
    "TrapSRH parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start trap srh"
        self.parserBlockName = "TrapSRH"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgument.append("{trapName}")
        self.blockArgumentIndexes = []
        self.blockArgumentIndexes.append(4)
        self.interpreterBlockHelpLine = "start trap srh for {trapName} "
