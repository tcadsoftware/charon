...
class charonLineParserDopingWidth:
    "DopingWidth parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "DopingWidth"
        self.parsingKey = "gradient width"
        ...
        self.interpreterHelpLine = "gradient width = {width} [ in x [ in y [ in z]]] "
        self.interpreterQuickHelp = "Set the range over which the doping ramps from the minimum to maximum values in x  y or z"
        self.interpreterLongHelp = "Set the range over which the doping ramps from the minimum to maximum values in x  y or z <> {width} is the width of the gradent"
        ...
        self.xmlRequiredArgument.append("{width}")
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},X Width,double,{width}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Y Width,double,{width}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Z Width,double,{width}")
