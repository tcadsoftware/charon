...
class charonLineParserMGaussErfc:
    "MGaussErfc parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MGaussErfc"
        self.parsingKey = "erfc"
        ...
        self.interpreterHelpLine = "erfc [in x [in y [in z]]] "
        self.interpreterQuickHelp = "Use a complimentary error function in the specified direction."
        self.interpreterLongHelp = "Instead of a gaussian in the given direction use a complimentary error function variation in the given direction."
        ...
        self.xmlOptionalLines[0].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},X ERFC_ON,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},Y ERFC_ON,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Closure Models->{MaterialBlockName}->Doping->{functionName},X ERFC_ON,bool,true")
