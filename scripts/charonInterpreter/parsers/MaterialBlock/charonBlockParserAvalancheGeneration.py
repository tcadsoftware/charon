...
class charonBlockParserAvalancheGeneration:
    "AvalancheGeneration parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start avalanche generation"
        self.parserBlockName = "AvalancheGeneration"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start avalanche generation "
