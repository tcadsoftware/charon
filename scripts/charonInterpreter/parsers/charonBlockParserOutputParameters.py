...
class charonBlockParserOutputParameters:
    "OutputParameters parser"

    def __init__(self):
        # Register the parsing keys
        self.parsingBlockKey = "start output parameters"
        self.parserBlockName = "OutputParameters"

        # Register the block arguments
        self.blockArgument = []
        self.blockArgumentIndexes = []
        self.interpreterBlockHelpLine = "start output parameters "
