...
class charonLineParserMinimumStepSize:
    "MinimumStepSize parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MinimumStepSize"
        self.parsingKey = "minimum step size"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Minimum Step Size = {stepSize} "
        self.interpreterQuickHelp = "Specify minimum step size for parameter sweep"
        self.interpreterLongHelp = "Specify minimum step size for parameter sweep <> {stepSize} = the step size"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Step Size,Min Step Size,double,{stepSize}")
