...
class charonLineParserMinValue:
    "MinValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MinValue"
        self.parsingKey = "min value"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "min value = {minval} "
        self.interpreterQuickHelp = "Specify minimum value for continuation window"
        self.interpreterLongHelp = "Specify minimum value for continuation window"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Stepper,Min Value,double,{minval}")
        ...
        self.xmlRequiredArgument.append("{minval}")
