...
class charonLineParserStepSizeAggressiveness:
    "StepSizeAggressiveness parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "StepSizeAggressiveness"
        self.parsingKey = "step size aggressiveness"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Step Size Aggressiveness = {aggressiveness} "
        self.interpreterQuickHelp = "Specify aggressiveness in modifying step size during parameter sweep"
        self.interpreterLongHelp = "Specify aggressiveness in modifying step size during parameter sweep <> {aggressiveness} is the aggressiveness <> Default = 1.0"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Step Size,Aggressiveness,double,{aggressiveness}")
        ...
        self.xmlRequiredArgument.append("{aggressiveness}")
