...
class charonLineParserMaxValue:
    "MaxValue parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MaxValue"
        self.parsingKey = "max value"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "max value = {maxval} "
        self.interpreterQuickHelp = "Specify maximum value for continuation window"
        self.interpreterLongHelp = "Specify maximum value for continuation window"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Stepper,Max Value,double,{maxval}")
        ...
        self.xmlRequiredArgument.append("{maxval}")
