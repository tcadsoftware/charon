...
class charonLineParserSuccessfulStepIncreaseFac:
    "SuccessfulStepIncreaseFac parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "SuccessfulStepIncreaseFac"
        self.parsingKey = "successful step increase factor"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "successful step increase factor = {factor} "
        self.interpreterQuickHelp = "Specify successful step increase factor in modifying step size during parameter sweep"
        self.interpreterLongHelp = "Specify successful step increase factor in modifying step size during parameter sweep"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Step Size,Successful Step Increase Factor,double,{factor}")
        ...
        self.xmlRequiredArgument.append("{factor}")
