...
class charonLineParserPredictorMethod:
    "PredictorMethod parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "PredictorMethod"
        self.parsingKey = "predictor method"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("constant")
        self.parsingKeyOptional.append("secant")
        self.parsingKeyOptional.append("tangent")
        self.interpreterHelpLine = "predictor method is [ constant [ secant [tangent ]]] "
        self.interpreterQuickHelp = "Specify the continuation predictor method to use  Constant  Secant or Tangent"
        self.interpreterLongHelp = "Specify the continuation predictor method to use  Constant  Secant or Tangent"
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->LOCA->Predictor,Method,string,Constant")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Solution Control->LOCA->Predictor,Method,string,Secant")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[2].append(" Charon->Solution Control->LOCA->Predictor,Method,string,Tangent")
