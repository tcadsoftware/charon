...
class charonLineParserInitialStepSize:
    "InitialStepSize parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "InitialStepSize"
        self.parsingKey = "initial step size"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Initial Step Size = {stepSize} "
        self.interpreterQuickHelp = "Specify initial step size for parameter sweep"
        self.interpreterLongHelp = "Specify initial step size for parameter sweep <> {stepSize} = the step size"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Step Size,Initial Step Size,double,{stepSize}")
        ...
        self.xmlRequiredArgument.append("{stepSize}")
