...
class charonLineParserMaximumStepSize:
    "MaximumStepSize parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "MaximumStepSize"
        self.parsingKey = "maximum step size"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Maximum Step Size = {stepSize} "
        self.interpreterQuickHelp = "Specify maximum step size for parameter sweep"
        self.interpreterLongHelp = "Specify maximum step size for parameter sweep <> {stepSize} = the step size"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Solution Control->LOCA->Step Size,Max Step Size,double,{stepSize}")
