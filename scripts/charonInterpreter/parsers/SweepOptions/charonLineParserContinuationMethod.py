...
class charonLineParserContinuationMethod:
    "ContinuationMethod parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ContinuationMethod"
        self.parsingKey = "continuation method"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("arc length")
        self.parsingKeyOptional.append("natural")
        self.interpreterHelpLine = "continuation method is [ arc length [ natural ]] "
        self.interpreterQuickHelp = "Specify the continuation method to use  Arc Length or Natural"
        self.interpreterLongHelp = "Specify the continuation method to use  Arc Length or Natural"
        ...
        self.xmlOptionalLines[0].append(" Charon->Solution Control->LOCA->Stepper,Continuation Method,string,Arc Length")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append("    Charon->Solution Control->LOCA->Stepper,Continuation Method,string,Natural")
