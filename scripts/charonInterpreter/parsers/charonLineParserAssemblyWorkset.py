...
class charonLineParserAssemblyWorkset:
    "AssemblyWorkset parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "AssemblyWorkset"
        self.parsingKey = "assembly workset"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Assembly Workset = {size} "
        self.interpreterQuickHelp = "Set the Charon workset size "
        self.interpreterLongHelp = " Set the Charon workset size <> size is the the size"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Assembly,Workset Size,int,{size}")
        ...
        self.xmlDefaultLines.append(" Charon->Assembly,Workset Size,int,1000")
