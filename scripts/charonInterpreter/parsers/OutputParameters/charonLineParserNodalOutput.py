...
class charonLineParserNodalOutput:
    "NodalOutput parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "NodalOutput"
        self.parsingKey = "output nodal variables"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "Output nodal variables in {regionName} for {variableNames} "
        self.interpreterQuickHelp = "Output named nodal variables"
        self.interpreterLongHelp = "Output named nodal variables <> {regionName} must be supplied <> variableNames must be in quotes"

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Output->Nodal Quantities,{regionName},string,{variableNames}")
        ...
        self.xmlRequiredArgument.append("{variableNames}")
