...
class charonLineParserCellAverageOutput:
    "CellAverageOutput parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "CellAverageOutput"
        self.parsingKey = "output cell average variables"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("scalar")
        self.parsingKeyOptional.append("vector")
        self.interpreterHelpLine = "Output cell average variables in {regionName} for [ scalar {variableNames} [ vector {variableNames} ]] "
        self.interpreterQuickHelp = "Output named cell averaged variables"
        self.interpreterLongHelp = "Output named cell averaged variables <> {regionName} must be supplied <> variableNames must be in quotes"
        ...
        self.xmlRequiredArgument.append("{regionName}")
        ...
        self.xmlOptionalLines[0].append(" Charon->Output->Cell Average Quantities,{regionName},string,{variableNames}")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Output->Cell Average Vectors,{regionName},string,{variableNames}")
        ...
        self.xmlOptionalArgument = [['{variableNames}'], ['{variableNames}']]
        self.xmlOptionalArgumentIndexes = [[1], [1]]
