...
class charonLineParserUnscaleVariables:
    "UnscaleVariables parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "UnscaleVariables"
        self.parsingKey = "unscale variables"
        self.parsingKeyOptional = []
        self.parsingKeyOptional.append("is on")
        self.parsingKeyOptional.append("is off")
        self.interpreterHelpLine = "Unscale Variables [ is on [ is off ]] "
        self.interpreterQuickHelp = "Unscale the variables."
        self.interpreterLongHelp = "Equations and variables are scaled in the system to enable stable solutions.  Unscale them to physical values."
        ...
        self.xmlOptionalLines[0].append(" Charon->Output,Unscale Variables,bool,true")
        self.xmlOptionalLines.append([])
        self.xmlOptionalLines[1].append(" Charon->Output,Unscale Variables,bool,false")
