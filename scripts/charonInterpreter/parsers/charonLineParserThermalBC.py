...
class charonLineParserThermalBC:
    "ThermalBC parser"

    def __init__(self):
        # Register the parsing keys
        self.parserName = "ThermalBC"
        self.parsingKey = "bc is thermal contact for"
        self.parsingKeyOptional = []
        self.interpreterHelpLine = "BC is thermal contact for {sidesetID} on {geometryBlock} fixed at {temperature} "
        self.interpreterQuickHelp = "Specify the temperature on a contact"
        self.interpreterLongHelp = "Specify the temperature on a contact. <> sidesetID is the contact name/type <> geometryBlock is the geometry name the contact is attached to <> temperature is the value in kelvin."

        # Register the xml required lines
        self.xmlRequiredLines = []
        self.xmlRequiredLinePriority = []
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ThermalANONYMOUS,Type,string,Dirichlet")
        ...
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ThermalANONYMOUS,Strategy,string,Thermal Contact")
        self.xmlRequiredLines.append("Charon->Boundary Conditions->{sidesetID}ThermalANONYMOUS->Data,Temperature,double,{temperature}")
        ...
        self.xmlRequiredArgument.append("{temperature}")
