...
#ifndef CHARON_SGCHARON1_POTENTIALFLUX_DECL_HPP
#define CHARON_SGCHARON1_POTENTIALFLUX_DECL_HPP
...
// primary edges which is the same implementation as in Charon1.

template<typename EvalT, typename Traits>
class SGCharon1_PotentialFlux
  :
...
}; // end of class SGCharon1_PotentialFlux
