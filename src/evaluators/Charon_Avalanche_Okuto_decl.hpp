...
#ifndef CHARON_AVALANCHE_OKUTO_DECL_HPP
#define CHARON_AVALANCHE_OKUTO_DECL_HPP
...
//! obtain Okuto avalanche (impact ionization) generation rate
template<typename EvalT, typename Traits>
class Avalanche_Okuto
  :
...
private:
  ...
  double a_e, b_e, c_e, d_e, gamma_e, delta_e;
  double a_h, b_h, c_h, d_h, gamma_h, delta_h;
