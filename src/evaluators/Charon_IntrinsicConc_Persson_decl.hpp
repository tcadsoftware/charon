...
#ifndef CHARON_INTRINSICCONC_PERSSON_DECL_HPP
#define CHARON_INTRINSICCONC_PERSSON_DECL_HPP
...
//! calculate the effective intrinsic concentration 

template<typename EvalT, typename Traits>
class IntrinsicConc_Persson
  :
...
private:
  ...
  // material parameters
  double anc, bnc, cnc, anv, bnv, cnv;
  double apc, bpc, cpc, apv, bpv, cpv;

  bool includeBGN;

  Teuchos::RCP<Teuchos::ParameterList> getValidParameters() const;

}; // end of class IntrinsicConc_Persson
