...
#ifndef CHARON_MOBILITY_DOPANTTEMPDEP_DECL_HPP
#define CHARON_MOBILITY_DOPANTTEMPDEP_DECL_HPP
...
private:
  ...
  PHX::MDField<const ScalarT,Cell,Point> dopant_density;
  ...
  double minDopDens, maxDopDens;
  double maxActE, minActE, slopeActE;
  double mobVal0;

  Teuchos::RCP<Teuchos::ParameterList> getValidParameters() const;

}; // end of class Mobility_DopantTempDep
