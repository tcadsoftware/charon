...
#ifndef CHARON_MOBILITY_PHILIPSTHOMAS_DECL_HPP
#define CHARON_MOBILITY_PHILIPSTHOMAS_DECL_HPP
...
//! Philips-Thomas mobility model

template<typename EvalT, typename Traits>
class Mobility_PhilipsThomas
  :
...
private:
  ...
  // compute Philips-Thomas mobility for CVFEM-SG and EFFPG-FEM at primary edge center
  ScalarT evalPTMobForEdgedl(const std::size_t& cell, const int& edge, const ScalarT& edgelfMob,
    const Kokkos::DynRankView<double,PHX::Device>& edgePoints, const ScalarT& edgeLatt);

  // compute Philips-Thomas mobility for SUPG-FEM at IP
  ScalarT evalPTMobForIPdl(const std::size_t& cell, const int& point, const ScalarT& lfMob);
  ...
  //disable lattice scattering for MOSFET models with a perpendicular field model
  bool disableLatticeScattering;

  Teuchos::RCP<Teuchos::ParameterList> getValidParameters() const;

}; // end of class Mobility_PhilipsThomas
