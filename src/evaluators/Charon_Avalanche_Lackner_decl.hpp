...
#ifndef CHARON_AVALANCHE_LACKNER_DECL_HPP
#define CHARON_AVALANCHE_LACKNER_DECL_HPP
...
//! obtain Lackner avalanche (impact ionization) generation rate
template<typename EvalT, typename Traits>
class Avalanche_Lackner
  :
...
private:
  ...
  double a_e, b_e, hbarOmega_e;
  double a_h, b_h, hbarOmega_h;
...
}; // end of class Avalanche_Lackner
