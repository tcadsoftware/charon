...
#ifndef CHARON_NOX_OBSERVER_EPETRA_OUTPUT_HPP
#define CHARON_NOX_OBSERVER_EPETRA_OUTPUT_HPP
...
namespace charon {
  ...
  /** This class outputs the linear system solve at each newton step.
    ...
    *
    */
  class NOXObserver_EpetraOutput : public NOX::Abstract::PrePostOperator {

  public:

    NOXObserver_EpetraOutput()
       : prefix_(""), counter_(0)
    { }
