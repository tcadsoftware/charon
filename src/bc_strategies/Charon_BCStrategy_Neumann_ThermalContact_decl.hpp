...
#ifndef CHARON_BCSTRATEGY_NEUMANN_THERMALCONTACT_DECL_HPP
#define CHARON_BCSTRATEGY_NEUMANN_THERMALCONTACT_DECL_HPP
...
namespace charon {
  ...
  class BCStrategy_Neumann_ThermalContact : public panzer::BCStrategy_Neumann_DefaultImpl<EvalT> {
