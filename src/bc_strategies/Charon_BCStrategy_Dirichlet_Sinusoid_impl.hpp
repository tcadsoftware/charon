...
#ifndef CHARON_BCSTRATEGY_DIRICHLET_SINUSOID_IMPL_HPP
#define CHARON_BCSTRATEGY_DIRICHLET_SINUSOID_IMPL_HPP
...
// Evaluators
#include "Charon_BC_Sinusoid.hpp"
#include "Charon_DDLatticeBC_Sinusoid.hpp"


// ***********************************************************************
template <typename EvalT>
charon::BCStrategy_Dirichlet_Sinusoid<EvalT>::
...
{
  TEUCHOS_ASSERT(this->m_bc.strategy() == "Sinusoid");
...
// ***********************************************************************
template <typename EvalT>
void charon::BCStrategy_Dirichlet_Sinusoid<EvalT>::
                           ...
                           const Teuchos::ParameterList& user_data) const
{
 ...
 // It should be optional to specify the second sinusoidal voltage
  ...
  // build DDLatticeBC_Sinusoid for DD+Lattice, DD+Ion, and DD+Lattice+Ion formulations
  ...
  // build the BC_Sinusoid evaluator for isothermal DD formulations
  else
  {
    RCP< PHX::Evaluator<panzer::Traits> > op =
      rcp(new charon::BC_Sinusoid<EvalT,panzer::Traits>(p));
