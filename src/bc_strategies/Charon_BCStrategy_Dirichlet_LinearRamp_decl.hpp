...
#ifndef CHARON_BCSTRATEGY_DIRICHLET_LINEARRAMP_DECL_HPP
#define CHARON_BCSTRATEGY_DIRICHLET_LINEARRAMP_DECL_HPP
...
namespace charon {
  ...
  class BCStrategy_Dirichlet_LinearRamp : public panzer::BCStrategy_Dirichlet_DefaultImpl<EvalT> {
