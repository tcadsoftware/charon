...
#ifndef CHARON_BCSTRATEGY_DIRICHLET_PERIODIC_DECL_HPP
#define CHARON_BCSTRATEGY_DIRICHLET_PERIODIC_DECL_HPP
...
namespace charon {
  ...
  class BCStrategy_Dirichlet_Periodic : public panzer::BCStrategy_Dirichlet_DefaultImpl<EvalT> {
