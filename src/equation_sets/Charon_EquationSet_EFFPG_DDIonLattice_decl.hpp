...
#ifndef CHARON_EQUATIONSET_EFFPG_DDIONLATTICE_DECL_HPP
#define CHARON_EQUATIONSET_EFFPG_DDIONLATTICE_DECL_HPP
...
namespace charon {
  ...
  class EquationSet_EFFPG_DDIonLattice : public charon::EquationSet_DefaultImpl<EvalT> {
