...
#ifndef CHARON_EQUATIONSET_SGCVFEM_LAPLACE_DECL_HPP
#define CHARON_EQUATIONSET_SGCVFEM_LAPLACE_DECL_HPP
...
namespace charon {
  ...
  class EquationSet_SGCVFEM_Laplace : public charon::EquationSet_DefaultImpl<EvalT>
  {
  public:
