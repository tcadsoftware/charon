...
#ifndef CHARON_EQUATIONSET_LAPLACE_DECL_HPP
#define CHARON_EQUATIONSET_LAPLACE_DECL_HPP
...
namespace charon {
  ...
  class EquationSet_Laplace : public charon::EquationSet_DefaultImpl<EvalT>
  {
  public:
