...
#ifndef CHARON_EQUATIONSET_SGCHARON1_DRIFTDIFFUSION_DECL_HPP
#define CHARON_EQUATIONSET_SGCHARON1_DRIFTDIFFUSION_DECL_HPP
...
namespace charon {
  ...
  class EquationSet_SGCharon1_DriftDiffusion : public charon::EquationSet_DefaultImpl<EvalT> {
