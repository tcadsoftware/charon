...
export pathToReport='/projects/charon/Testing/Regression/Chama'
...
cat ${WORKSPACE}/tcad-charon/src/cmake/ctest/machines/chama/chama.sbatch.sh.TEMPL | sed -e s/TIMEVAL/${TIME}/g > ${WORKSPACE}/batch-job.sh
